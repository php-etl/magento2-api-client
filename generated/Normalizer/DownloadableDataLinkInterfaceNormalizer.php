...
class DownloadableDataLinkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\DownloadableDataLinkInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\DownloadableDataLinkInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\DownloadableDataLinkInterface();
        ...
        if (\array_key_exists('link_file_content', $data) && $data['link_file_content'] !== null) {
            $object->setLinkFileContent($this->denormalizer->denormalize($data['link_file_content'], 'Kiboko\\Magento\\Model\\DownloadableDataFileContentInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('sample_file_content', $data) && $data['sample_file_content'] !== null) {
            $object->setSampleFileContent($this->denormalizer->denormalize($data['sample_file_content'], 'Kiboko\\Magento\\Model\\DownloadableDataFileContentInterface', 'json', $context));
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('numberOfDownloads') && null !== $object->getNumberOfDownloads()) {
            $data['number_of_downloads'] = $object->getNumberOfDownloads();
        }
        $data['link_type'] = $object->getLinkType();
        if ($object->isInitialized('linkFile') && null !== $object->getLinkFile()) {
            $data['link_file'] = $object->getLinkFile();
        }
        if ($object->isInitialized('linkFileContent') && null !== $object->getLinkFileContent()) {
            $data['link_file_content'] = $this->normalizer->normalize($object->getLinkFileContent(), 'json', $context);
        }
        if ($object->isInitialized('linkUrl') && null !== $object->getLinkUrl()) {
            $data['link_url'] = $object->getLinkUrl();
        }
        $data['sample_type'] = $object->getSampleType();
        if ($object->isInitialized('sampleFile') && null !== $object->getSampleFile()) {
            $data['sample_file'] = $object->getSampleFile();
        }
        if ($object->isInitialized('sampleFileContent') && null !== $object->getSampleFileContent()) {
            $data['sample_file_content'] = $this->normalizer->normalize($object->getSampleFileContent(), 'json', $context);
        }
        if ($object->isInitialized('sampleUrl') && null !== $object->getSampleUrl()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\DownloadableDataLinkInterface' => false);
    }
}