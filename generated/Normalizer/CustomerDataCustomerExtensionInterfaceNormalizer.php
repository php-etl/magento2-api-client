...
class CustomerDataCustomerExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('assistance_allowed', $data) && $data['assistance_allowed'] !== null) {
            $object->setAssistanceAllowed($data['assistance_allowed']);
        }
        elseif (\array_key_exists('assistance_allowed', $data) && $data['assistance_allowed'] === null) {
            $object->setAssistanceAllowed(null);
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('assistanceAllowed') && null !== $object->getAssistanceAllowed()) {
            $data['assistance_allowed'] = $object->getAssistanceAllowed();
        }
