...
class DirectoryDataCurrencyInformationInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\DirectoryDataCurrencyInformationInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\DirectoryDataCurrencyInformationInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\DirectoryDataCurrencyInformationInterface();
        ...
        if (\array_key_exists('exchange_rates', $data) && $data['exchange_rates'] !== null) {
            ...
            foreach ($data['exchange_rates'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\Model\\DirectoryDataExchangeRateInterface', 'json', $context);
            }
    ...
    {
        return array('Kiboko\\Magento\\Model\\DirectoryDataCurrencyInformationInterface' => false);
    }
}