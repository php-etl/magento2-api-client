...
class FrameworkSearchSearchResultInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\FrameworkSearchSearchResultInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\FrameworkSearchSearchResultInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\FrameworkSearchSearchResultInterface();
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\Model\\FrameworkSearchDocumentInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('aggregations', $data) && $data['aggregations'] !== null) {
            $object->setAggregations($this->denormalizer->denormalize($data['aggregations'], 'Kiboko\\Magento\\Model\\FrameworkSearchAggregationInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('search_criteria', $data) && $data['search_criteria'] !== null) {
            $object->setSearchCriteria($this->denormalizer->denormalize($data['search_criteria'], 'Kiboko\\Magento\\Model\\FrameworkSearchSearchCriteriaInterface', 'json', $context));
        }
    ...
    {
        return array('Kiboko\\Magento\\Model\\FrameworkSearchSearchResultInterface' => false);
    }
}