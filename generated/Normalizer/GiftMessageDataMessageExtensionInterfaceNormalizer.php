...
class GiftMessageDataMessageExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\GiftMessageDataMessageExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\GiftMessageDataMessageExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\GiftMessageDataMessageExtensionInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\GiftMessageDataMessageExtensionInterface' => false);
    }
}