...
class QuoteDataProductOptionExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('grouped_options', $data) && $data['grouped_options'] !== null) {
            $values_2 = array();
            foreach ($data['grouped_options'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\Model\\GroupedProductDataGroupedOptionsInterface', 'json', $context);
            }
            $object->setGroupedOptions($values_2);
        }
        elseif (\array_key_exists('grouped_options', $data) && $data['grouped_options'] === null) {
            $object->setGroupedOptions(null);
        }
        if (\array_key_exists('configurable_item_options', $data) && $data['configurable_item_options'] !== null) {
            $values_3 = array();
            foreach ($data['configurable_item_options'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface', 'json', $context);
            }
            $object->setConfigurableItemOptions($values_3);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('groupedOptions') && null !== $object->getGroupedOptions()) {
            $values_2 = array();
            foreach ($object->getGroupedOptions() as $value_2) {
                $values_2[] = $this->normalizer->normalize($value_2, 'json', $context);
            }
            $data['grouped_options'] = $values_2;
        }
        if ($object->isInitialized('configurableItemOptions') && null !== $object->getConfigurableItemOptions()) {
            $values_3 = array();
            foreach ($object->getConfigurableItemOptions() as $value_3) {
                $values_3[] = $this->normalizer->normalize($value_3, 'json', $context);
            }
            $data['configurable_item_options'] = $values_3;
        }
        return $data;
    }
