...
class V1ProductsSkuDownloadableLinksIdPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\V1ProductsSkuDownloadableLinksIdPutBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\V1ProductsSkuDownloadableLinksIdPutBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\V1ProductsSkuDownloadableLinksIdPutBody();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('link', $data) && $data['link'] !== null) {
            $object->setLink($this->denormalizer->denormalize($data['link'], 'Kiboko\\Magento\\Model\\DownloadableDataLinkInterface', 'json', $context));
        }
    ...
    {
        return array('Kiboko\\Magento\\Model\\V1ProductsSkuDownloadableLinksIdPutBody' => false);
    }
}