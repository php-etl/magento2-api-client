...
class SalesDataOrderPaymentInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataOrderPaymentInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataOrderPaymentInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataOrderPaymentInterface();
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\Model\\SalesDataOrderPaymentExtensionInterface', 'json', $context));
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('addressStatus') && null !== $object->getAddressStatus()) {
            $data['address_status'] = $object->getAddressStatus();
        }
        if ($object->isInitialized('amountAuthorized') && null !== $object->getAmountAuthorized()) {
            $data['amount_authorized'] = $object->getAmountAuthorized();
        }
        if ($object->isInitialized('amountCanceled') && null !== $object->getAmountCanceled()) {
            $data['amount_canceled'] = $object->getAmountCanceled();
        }
        if ($object->isInitialized('amountOrdered') && null !== $object->getAmountOrdered()) {
        ...
        if ($object->isInitialized('amountRefunded') && null !== $object->getAmountRefunded()) {
            $data['amount_refunded'] = $object->getAmountRefunded();
        }
        if ($object->isInitialized('anetTransMethod') && null !== $object->getAnetTransMethod()) {
            $data['anet_trans_method'] = $object->getAnetTransMethod();
        }
        if ($object->isInitialized('baseAmountAuthorized') && null !== $object->getBaseAmountAuthorized()) {
            $data['base_amount_authorized'] = $object->getBaseAmountAuthorized();
        }
        if ($object->isInitialized('baseAmountCanceled') && null !== $object->getBaseAmountCanceled()) {
            $data['base_amount_canceled'] = $object->getBaseAmountCanceled();
        }
        if ($object->isInitialized('baseAmountOrdered') && null !== $object->getBaseAmountOrdered()) {
            $data['base_amount_ordered'] = $object->getBaseAmountOrdered();
        }
        if ($object->isInitialized('baseAmountPaid') && null !== $object->getBaseAmountPaid()) {
            $data['base_amount_paid'] = $object->getBaseAmountPaid();
        }
        if ($object->isInitialized('baseAmountPaidOnline') && null !== $object->getBaseAmountPaidOnline()) {
            $data['base_amount_paid_online'] = $object->getBaseAmountPaidOnline();
        }
        if ($object->isInitialized('baseAmountRefunded') && null !== $object->getBaseAmountRefunded()) {
            $data['base_amount_refunded'] = $object->getBaseAmountRefunded();
        }
        if ($object->isInitialized('baseAmountRefundedOnline') && null !== $object->getBaseAmountRefundedOnline()) {
        ...
        if ($object->isInitialized('baseShippingCaptured') && null !== $object->getBaseShippingCaptured()) {
        ...
        if ($object->isInitialized('ccApproval') && null !== $object->getCcApproval()) {
            $data['cc_approval'] = $object->getCcApproval();
        }
        if ($object->isInitialized('ccAvsStatus') && null !== $object->getCcAvsStatus()) {
            $data['cc_avs_status'] = $object->getCcAvsStatus();
        }
        if ($object->isInitialized('ccCidStatus') && null !== $object->getCcCidStatus()) {
            $data['cc_cid_status'] = $object->getCcCidStatus();
        }
        if ($object->isInitialized('ccDebugRequestBody') && null !== $object->getCcDebugRequestBody()) {
            $data['cc_debug_request_body'] = $object->getCcDebugRequestBody();
        }
        if ($object->isInitialized('ccDebugResponseBody') && null !== $object->getCcDebugResponseBody()) {
            $data['cc_debug_response_body'] = $object->getCcDebugResponseBody();
        }
        if ($object->isInitialized('ccDebugResponseSerialized') && null !== $object->getCcDebugResponseSerialized()) {
            $data['cc_debug_response_serialized'] = $object->getCcDebugResponseSerialized();
        }
        if ($object->isInitialized('ccExpMonth') && null !== $object->getCcExpMonth()) {
            $data['cc_exp_month'] = $object->getCcExpMonth();
        }
        if ($object->isInitialized('ccExpYear') && null !== $object->getCcExpYear()) {
            $data['cc_exp_year'] = $object->getCcExpYear();
        }
        $data['cc_last4'] = $object->getCcLast4();
        if ($object->isInitialized('ccNumberEnc') && null !== $object->getCcNumberEnc()) {
            $data['cc_number_enc'] = $object->getCcNumberEnc();
        }
        if ($object->isInitialized('ccOwner') && null !== $object->getCcOwner()) {
            $data['cc_owner'] = $object->getCcOwner();
        }
        if ($object->isInitialized('ccSecureVerify') && null !== $object->getCcSecureVerify()) {
            $data['cc_secure_verify'] = $object->getCcSecureVerify();
        }
        if ($object->isInitialized('ccSsIssue') && null !== $object->getCcSsIssue()) {
            $data['cc_ss_issue'] = $object->getCcSsIssue();
        }
        if ($object->isInitialized('ccSsStartMonth') && null !== $object->getCcSsStartMonth()) {
            $data['cc_ss_start_month'] = $object->getCcSsStartMonth();
        }
        if ($object->isInitialized('ccSsStartYear') && null !== $object->getCcSsStartYear()) {
            $data['cc_ss_start_year'] = $object->getCcSsStartYear();
        }
        if ($object->isInitialized('ccStatus') && null !== $object->getCcStatus()) {
            $data['cc_status'] = $object->getCcStatus();
        }
        if ($object->isInitialized('ccStatusDescription') && null !== $object->getCcStatusDescription()) {
            $data['cc_status_description'] = $object->getCcStatusDescription();
        }
        if ($object->isInitialized('ccTransId') && null !== $object->getCcTransId()) {
            $data['cc_trans_id'] = $object->getCcTransId();
        }
        if ($object->isInitialized('ccType') && null !== $object->getCcType()) {
            $data['cc_type'] = $object->getCcType();
        }
        if ($object->isInitialized('echeckAccountName') && null !== $object->getEcheckAccountName()) {
            $data['echeck_account_name'] = $object->getEcheckAccountName();
        }
        if ($object->isInitialized('echeckAccountType') && null !== $object->getEcheckAccountType()) {
            $data['echeck_account_type'] = $object->getEcheckAccountType();
        }
        if ($object->isInitialized('echeckBankName') && null !== $object->getEcheckBankName()) {
            $data['echeck_bank_name'] = $object->getEcheckBankName();
        }
        if ($object->isInitialized('echeckRoutingNumber') && null !== $object->getEcheckRoutingNumber()) {
            $data['echeck_routing_number'] = $object->getEcheckRoutingNumber();
        }
        if ($object->isInitialized('echeckType') && null !== $object->getEcheckType()) {
            $data['echeck_type'] = $object->getEcheckType();
        }
        if ($object->isInitialized('entityId') && null !== $object->getEntityId()) {
            $data['entity_id'] = $object->getEntityId();
        }
        if ($object->isInitialized('lastTransId') && null !== $object->getLastTransId()) {
        ...
        if ($object->isInitialized('protectionEligibility') && null !== $object->getProtectionEligibility()) {
            $data['protection_eligibility'] = $object->getProtectionEligibility();
        }
        if ($object->isInitialized('quotePaymentId') && null !== $object->getQuotePaymentId()) {
        ...
        if ($object->isInitialized('shippingCaptured') && null !== $object->getShippingCaptured()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataOrderPaymentInterface' => false);
    }
}