...
class BundleDataOptionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\BundleDataOptionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\BundleDataOptionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\BundleDataOptionInterface();
        ...
        if (\array_key_exists('product_links', $data) && $data['product_links'] !== null) {
            ...
            foreach ($data['product_links'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\Model\\BundleDataLinkInterface', 'json', $context);
            }
    ...
    {
        return array('Kiboko\\Magento\\Model\\BundleDataOptionInterface' => false);
    }
}