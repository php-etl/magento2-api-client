...
class ConfigurableProductDataConfigurableItemOptionValueInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\ConfigurableProductDataConfigurableItemOptionValueInterface();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('optionValue') && null !== $object->getOptionValue()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface' => false);
    }
}