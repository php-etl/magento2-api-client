...
class SalesRuleDataRuleDiscountInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_3\\Model\\SalesRuleDataRuleDiscountInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_3\\Model\\SalesRuleDataRuleDiscountInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_3\Model\SalesRuleDataRuleDiscountInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('discount_data', $data)) {
            $object->setDiscountData($this->denormalizer->denormalize($data['discount_data'], 'Kiboko\\Magento\\v2_3\\Model\\SalesRuleDataDiscountDataInterface', 'json', $context));
        }
