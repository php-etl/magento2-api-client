...
class SalesDataOrderInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_3\Model\SalesDataOrderInterface();
        ...
        if (\array_key_exists('billing_address', $data) && $data['billing_address'] !== null) {
            $object->setBillingAddress($this->denormalizer->denormalize($data['billing_address'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderAddressInterface', 'json', $context));
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderExtensionInterface', 'json', $context));
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('payment', $data) && $data['payment'] !== null) {
            $object->setPayment($this->denormalizer->denormalize($data['payment'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderPaymentInterface', 'json', $context));
        ...
        if (\array_key_exists('status_histories', $data) && $data['status_histories'] !== null) {
            ...
            foreach ($data['status_histories'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderStatusHistoryInterface', 'json', $context);
            }
