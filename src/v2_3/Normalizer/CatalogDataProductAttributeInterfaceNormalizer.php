...
class CatalogDataProductAttributeInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_3\\Model\\CatalogDataProductAttributeInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_3\\Model\\CatalogDataProductAttributeInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_3\Model\CatalogDataProductAttributeInterface();
        ...
        if (\array_key_exists('options', $data)) {
            ...
            foreach ($data['options'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2_3\\Model\\EavDataAttributeOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('validation_rules', $data)) {
            ...
            foreach ($data['validation_rules'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Kiboko\\Magento\\V2_3\\Model\\EavDataAttributeValidationRuleInterface', 'json', $context);
            }
