    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2_3\\Model\\RmaDataItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tracks', $data)) {
            ...
            foreach ($data['tracks'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2_3\\Model\\RmaDataTrackInterface', 'json', $context);
            }
