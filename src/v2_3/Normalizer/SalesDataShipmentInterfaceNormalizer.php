...
class SalesDataShipmentInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('extension_attributes', $data)) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataShipmentExtensionInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2_3\\Model\\SalesDataShipmentItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('packages', $data)) {
            ...
            foreach ($data['packages'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2_3\\Model\\SalesDataShipmentPackageInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tracks', $data)) {
            ...
            foreach ($data['tracks'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2_3\\Model\\SalesDataShipmentTrackInterface', 'json', $context);
            }
