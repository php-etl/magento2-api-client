...
class AdobeStockAssetApiDataAssetInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_3\\Model\\AdobeStockAssetApiDataAssetInterface';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_3\\Model\\AdobeStockAssetApiDataAssetInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_3\Model\AdobeStockAssetApiDataAssetInterface();
        ...
        if (\array_key_exists('category', $data)) {
            $object->setCategory($this->denormalizer->denormalize($data['category'], 'Kiboko\\Magento\\v2_3\\Model\\AdobeStockAssetApiDataCategoryInterface', 'json', $context));
        }
        if (\array_key_exists('creator_id', $data)) {
            $object->setCreatorId($data['creator_id']);
        }
        if (\array_key_exists('creator', $data)) {
            $object->setCreator($this->denormalizer->denormalize($data['creator'], 'Kiboko\\Magento\\v2_3\\Model\\AdobeStockAssetApiDataCreatorInterface', 'json', $context));
        }
