...
class QuoteDataCartExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_3\\Model\\QuoteDataCartExtensionInterface';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_3\\Model\\QuoteDataCartExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_3\Model\QuoteDataCartExtensionInterface();
        ...
        if (\array_key_exists('shipping_assignments', $data)) {
            ...
            foreach ($data['shipping_assignments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_3\\Model\\QuoteDataShippingAssignmentInterface', 'json', $context);
            }
            $object->setShippingAssignments($values);
        }
        if (\array_key_exists('negotiable_quote', $data)) {
            $object->setNegotiableQuote($this->denormalizer->denormalize($data['negotiable_quote'], 'Kiboko\\Magento\\v2_3\\Model\\NegotiableQuoteDataNegotiableQuoteInterface', 'json', $context));
        }
        if (\array_key_exists('amazon_order_reference_id', $data)) {
            $object->setAmazonOrderReferenceId($this->denormalizer->denormalize($data['amazon_order_reference_id'], 'Kiboko\\Magento\\v2_3\\Model\\AmazonPaymentDataQuoteLinkInterface', 'json', $context));
        }
        return $object;
    }
    /**
