...
class SalesDataOrderItemInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderItemExtensionInterface', 'json', $context));
        ...
        if (\array_key_exists('parent_item', $data) && $data['parent_item'] !== null) {
            $object->setParentItem($this->denormalizer->denormalize($data['parent_item'], 'Kiboko\\Magento\\V2_3\\Model\\SalesDataOrderItemInterface', 'json', $context));
        ...
        if (\array_key_exists('product_option', $data) && $data['product_option'] !== null) {
            $object->setProductOption($this->denormalizer->denormalize($data['product_option'], 'Kiboko\\Magento\\V2_3\\Model\\CatalogDataProductOptionInterface', 'json', $context));
