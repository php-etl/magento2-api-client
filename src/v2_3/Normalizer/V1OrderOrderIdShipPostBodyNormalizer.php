    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('tracks', $data)) {
            ...
            foreach ($data['tracks'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_3\\Model\\SalesDataShipmentTrackCreationInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('packages', $data)) {
            ...
            foreach ($data['packages'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_3\\Model\\SalesDataShipmentPackageCreationInterface', 'json', $context);
            }
