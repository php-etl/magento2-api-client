...
class SalesRuleDataRuleInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('action_condition', $data) && $data['action_condition'] !== null) {
            $object->setActionCondition($this->denormalizer->denormalize($data['action_condition'], 'Kiboko\\Magento\\V2_3\\Model\\SalesRuleDataConditionInterface', 'json', $context));
        ...
        if (\array_key_exists('condition', $data) && $data['condition'] !== null) {
            $object->setCondition($this->denormalizer->denormalize($data['condition'], 'Kiboko\\Magento\\V2_3\\Model\\SalesRuleDataConditionInterface', 'json', $context));
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2_3\\Model\\SalesRuleDataRuleExtensionInterface', 'json', $context));
        ...
        if (\array_key_exists('store_labels', $data) && $data['store_labels'] !== null) {
            ...
            foreach ($data['store_labels'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2_3\\Model\\SalesRuleDataRuleLabelInterface', 'json', $context);
            }
