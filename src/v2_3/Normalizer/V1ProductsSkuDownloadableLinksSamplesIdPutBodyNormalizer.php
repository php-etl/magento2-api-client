...
class V1ProductsSkuDownloadableLinksSamplesIdPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_3\\Model\\V1ProductsSkuDownloadableLinksSamplesIdPutBody';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_3\\Model\\V1ProductsSkuDownloadableLinksSamplesIdPutBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_3\Model\V1ProductsSkuDownloadableLinksSamplesIdPutBody();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('sample', $data)) {
            $object->setSample($this->denormalizer->denormalize($data['sample'], 'Kiboko\\Magento\\v2_3\\Model\\DownloadableDataSampleInterface', 'json', $context));
        }
