...
class AsynchronousOperationsDataOperationSearchResultsInterface
{
    /**
     * List of operations.
     *
     * @var AsynchronousOperationsDataOperationInterface[]
     */
    protected $items;
    /**
     ...
     * List of operations.
     *
     * @param AsynchronousOperationsDataOperationInterface[] $items
     *
     * @return self
     */
