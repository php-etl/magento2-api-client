...
class CatalogInventoryStockRegistryV1UpdateStockItemBySkuPut extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $productSku, string $itemId, ?\Kiboko\Magento\v2_3\Model\V1ProductsProductSkuStockItemsItemIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1ProductsProductSkuStockItemsItemIdPutBody) {
