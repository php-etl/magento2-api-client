...
class CompanyRoleRepositoryV1SavePut extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Kiboko\Magento\v2_3\Model\V1CompanyRoleIdPutBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1CompanyRoleIdPutBody) {
