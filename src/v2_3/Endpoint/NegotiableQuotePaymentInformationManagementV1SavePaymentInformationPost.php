...
class NegotiableQuotePaymentInformationManagementV1SavePaymentInformationPost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, ?\Kiboko\Magento\v2_3\Model\V1NegotiableCartsCartIdSetPaymentInformationPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1NegotiableCartsCartIdSetPaymentInformationPostBody) {
