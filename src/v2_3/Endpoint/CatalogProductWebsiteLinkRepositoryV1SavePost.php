...
class CatalogProductWebsiteLinkRepositoryV1SavePost extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuWebsitesPostBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1ProductsSkuWebsitesPostBody) {
