...
class CheckoutGuestTotalsInformationManagementV1CalculatePost extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdTotalsInformationPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdTotalsInformationPostBody) {
