...
class EavAttributeSetRepositoryV1SavePut extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeSetId, ?\Kiboko\Magento\V2_3\Model\V1EavAttributeSetsAttributeSetIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1EavAttributeSetsAttributeSetIdPutBody) {
