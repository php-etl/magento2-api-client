...
class CustomerAccountManagementV1ActivatePut extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $email, ?\Kiboko\Magento\V2_3\Model\V1CustomersEmailActivatePutBody $requestBody = null)
    {
        $this->email = $email;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1CustomersEmailActivatePutBody) {
