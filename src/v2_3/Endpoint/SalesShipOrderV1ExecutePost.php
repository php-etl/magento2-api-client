...
class SalesShipOrderV1ExecutePost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $orderId, ?\Kiboko\Magento\v2_3\Model\V1OrderOrderIdShipPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1OrderOrderIdShipPostBody) {
