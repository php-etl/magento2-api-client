...
class QuotePaymentMethodManagementV1SetPut extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\v2_3\Model\V1CartsMineSelectedPaymentMethodPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1CartsMineSelectedPaymentMethodPutBody) {
