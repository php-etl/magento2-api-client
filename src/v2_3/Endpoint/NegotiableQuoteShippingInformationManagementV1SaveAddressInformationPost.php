...
class NegotiableQuoteShippingInformationManagementV1SaveAddressInformationPost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, \Kiboko\Magento\v2_3\Model\V1NegotiableCartsCartIdShippingInformationPostBody $negotiableQuoteShippingInformationManagementV1SaveAddressInformationPostBody)
    {
        $this->cartId = $cartId;
