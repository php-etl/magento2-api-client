...
class RmaRmaRepositoryV1DeleteDelete extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Kiboko\Magento\V2_3\Model\V1ReturnsIdDeleteBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1ReturnsIdDeleteBody) {
