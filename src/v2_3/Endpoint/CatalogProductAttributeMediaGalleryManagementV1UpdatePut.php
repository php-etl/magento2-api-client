...
class CatalogProductAttributeMediaGalleryManagementV1UpdatePut extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $entryId, ?\Kiboko\Magento\v2_3\Model\V1ProductsSkuMediaEntryIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1ProductsSkuMediaEntryIdPutBody) {
