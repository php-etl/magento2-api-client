...
class QuoteCartManagementV1CreateEmptyCartPost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Kiboko\Magento\v2_3\Exception\QuoteCartManagementV1CreateEmptyCartPostBadRequestException();
        }
        if (401 === $status) {
            throw new \Kiboko\Magento\v2_3\Exception\QuoteCartManagementV1CreateEmptyCartPostUnauthorizedException();
        }
        return null;
    }
