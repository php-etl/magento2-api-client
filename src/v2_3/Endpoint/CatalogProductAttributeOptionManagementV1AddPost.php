...
class CatalogProductAttributeOptionManagementV1AddPost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeCode, ?\Kiboko\Magento\v2_3\Model\V1ProductsAttributesAttributeCodeOptionsPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1ProductsAttributesAttributeCodeOptionsPostBody) {
