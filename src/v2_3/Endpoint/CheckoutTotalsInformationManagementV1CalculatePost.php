...
class CheckoutTotalsInformationManagementV1CalculatePost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, \Kiboko\Magento\v2_3\Model\V1CartsCartIdTotalsInformationPostBody $checkoutTotalsInformationManagementV1CalculatePostBody)
    {
        $this->cartId = $cartId;
