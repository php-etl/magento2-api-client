...
class CompanyCreditCreditBalanceManagementV1DecreasePost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
    ...
    {
        return '/V1/companyCredits/{creditId}/decreaseBalance';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Kiboko\Magento\v2_3\Exception\CompanyCreditCreditBalanceManagementV1DecreasePostUnauthorizedException();
        }
        return null;
    }
