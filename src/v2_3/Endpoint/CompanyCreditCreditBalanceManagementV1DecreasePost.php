...
class CompanyCreditCreditBalanceManagementV1DecreasePost extends \Kiboko\Magento\v2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $creditId, ?\Kiboko\Magento\v2_3\Model\V1CompanyCreditsCreditIdDecreaseBalancePostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_3\Model\V1CompanyCreditsCreditIdDecreaseBalancePostBody) {
