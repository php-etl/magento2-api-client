...
class CustomerAccountManagementV1ChangePasswordByIdPut extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2_3\Model\V1CustomersMePasswordPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1CustomersMePasswordPutBody) {
