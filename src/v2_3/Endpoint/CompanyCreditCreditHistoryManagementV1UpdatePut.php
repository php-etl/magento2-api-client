...
class CompanyCreditCreditHistoryManagementV1UpdatePut extends \Kiboko\Magento\V2_3\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_3\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $historyId, ?\Kiboko\Magento\V2_3\Model\V1CompanyCreditsHistoryHistoryIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_3\Model\V1CompanyCreditsHistoryHistoryIdPutBody) {
