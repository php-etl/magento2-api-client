...
class Client extends \Kiboko\Magento\V2_3\Runtime\Client\Client
{
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function amazonPaymentAddressManagementV1GetBillingAddressPut(string $amazonOrderReferenceId, ?\Kiboko\Magento\V2_3\Model\V1AmazonBillingAddressAmazonOrderReferenceIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\AmazonPaymentAddressManagementV1GetBillingAddressPut($amazonOrderReferenceId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param string $amazonOrderReferenceId
     * @param null|\Kiboko\Magento\V2_3\Model\V1AmazonShippingAddressAmazonOrderReferenceIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function amazonPaymentAddressManagementV1GetShippingAddressPut(string $amazonOrderReferenceId, ?\Kiboko\Magento\V2_3\Model\V1AmazonShippingAddressAmazonOrderReferenceIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\AmazonPaymentAddressManagementV1GetShippingAddressPut($amazonOrderReferenceId, $requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1BundleProductsOptionsAddPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function bundleProductOptionManagementV1SavePost(?\Kiboko\Magento\V2_3\Model\V1BundleProductsOptionsAddPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\BundleProductOptionManagementV1SavePost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1BundleProductsOptionsOptionIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function bundleProductOptionManagementV1SavePut(string $optionId, ?\Kiboko\Magento\V2_3\Model\V1BundleProductsOptionsOptionIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\BundleProductOptionManagementV1SavePut($optionId, $requestBody), $fetch);
    }
    /**
     ...
     * @param string $sku
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1BundleProductsSkuLinksIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function bundleProductLinkManagementV1SaveChildPut(string $sku, string $id, ?\Kiboko\Magento\V2_3\Model\V1BundleProductsSkuLinksIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\BundleProductLinkManagementV1SaveChildPut($sku, $id, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function bundleProductLinkManagementV1AddChildByProductSkuPost(string $sku, int $optionId, ?\Kiboko\Magento\V2_3\Model\V1BundleProductsSkuLinksOptionIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\BundleProductLinkManagementV1AddChildByProductSkuPost($sku, $optionId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsGuestCartsCartIdGiftCardsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsGuestCartsCartIdGiftCardsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftCardAccountGuestGiftCardAccountManagementV1AddGiftCardPost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * Save quote
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMinePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteCartRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteCartRepositoryV1SavePut(?\Kiboko\Magento\V2_3\Model\V1CartsMinePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartRepositoryV1SavePut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerBalanceBalanceManagementFromQuoteV1ApplyPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerBalanceBalanceManagementFromQuoteV1ApplyPost(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerBalanceBalanceManagementFromQuoteV1ApplyPost(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerBalanceBalanceManagementFromQuoteV1UnapplyPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerBalanceBalanceManagementFromQuoteV1UnapplyPost(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerBalanceBalanceManagementFromQuoteV1UnapplyPost(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineBillingAddressPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteBillingAddressManagementV1AssignPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineBillingAddressPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteBillingAddressManagementV1AssignPost($requestBody), $fetch);
    }
    /**
     *
     *
     ...
     *
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineCheckoutFieldsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingQuoteCartCheckoutFieldManagementV1SaveCheckoutFieldsPostBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingQuoteCartCheckoutFieldManagementV1SaveCheckoutFieldsPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingQuoteCartCheckoutFieldManagementV1SaveCheckoutFieldsPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineCheckoutFieldsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingQuoteCartCheckoutFieldManagementV1SaveCheckoutFieldsPost($requestBody), $fetch);
    }
    /**
     * Set shipping/billing methods and additional data for cart and collect totals.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineCollectTotalsPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function quoteCartTotalManagementV1CollectTotalsPut(?\Kiboko\Magento\V2_3\Model\V1CartsMineCollectTotalsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartTotalManagementV1CollectTotalsPut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1DeleteSearchRequestDeleteUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1DeleteSearchRequestDeleteInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointCartCollectionPointManagementV1DeleteSearchRequestDelete(), $fetch);
    }
    /**
     *
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineCollectionPointSearchRequestPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1SaveSearchRequestPutUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1SaveSearchRequestPutInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\TemandoShippingDataCollectionPointSearchRequestInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingCollectionPointCartCollectionPointManagementV1SaveSearchRequestPut(?\Kiboko\Magento\V2_3\Model\V1CartsMineCollectionPointSearchRequestPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointCartCollectionPointManagementV1SaveSearchRequestPut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1GetCollectionPointsGetUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\TemandoShippingDataCollectionPointQuoteCollectionPointInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointCartCollectionPointManagementV1GetCollectionPointsGet(), $fetch);
    }
    /**
     *
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineCollectionPointSelectPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1SelectCollectionPointPostUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointCartCollectionPointManagementV1SelectCollectionPointPostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingCollectionPointCartCollectionPointManagementV1SelectCollectionPointPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineCollectionPointSelectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointCartCollectionPointManagementV1SelectCollectionPointPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingQuoteCartDeliveryOptionManagementV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CartsMineDeliveryOptionPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingQuoteCartDeliveryOptionManagementV1SavePost($requestBody), $fetch);
    }
    /**
     * Estimate shipping by address and return list of available shipping methods
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineEstimateShippingMethodsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function quoteShipmentEstimationV1EstimateByExtendedAddressPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteShipmentEstimationV1EstimateByExtendedAddressPost($requestBody), $fetch);
    }
    /**
     * Estimate shipping
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteShippingMethodManagementV1EstimateByAddressIdPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineEstimateShippingMethodsByAddressIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteShippingMethodManagementV1EstimateByAddressIdPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineGiftMessagePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftMessageCartRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CartsMineGiftMessagePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftMessageCartRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $itemId The item ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineGiftMessageItemIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftMessageItemRepositoryV1SavePost(int $itemId, ?\Kiboko\Magento\V2_3\Model\V1CartsMineGiftMessageItemIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftMessageItemRepositoryV1SavePost($itemId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineGiftCardsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GiftCardAccountGiftCardAccountManagementV1SaveByQuoteIdPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftCardAccountGiftCardAccountManagementV1SaveByQuoteIdPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineGiftCardsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftCardAccountGiftCardAccountManagementV1SaveByQuoteIdPost($requestBody), $fetch);
    }
    /**
     * Remove GiftCard Account entity
     *
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineItemsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteCartItemRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CartsMineItemsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartItemRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $itemId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineItemsItemIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteCartItemRepositoryV1SavePut(string $itemId, ?\Kiboko\Magento\V2_3\Model\V1CartsMineItemsItemIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartItemRepositoryV1SavePut($itemId, $requestBody), $fetch);
    }
    /**
     * Places an order for a specified cart.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineOrderPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteCartManagementV1PlaceOrderPut(?\Kiboko\Magento\V2_3\Model\V1CartsMineOrderPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartManagementV1PlaceOrderPut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMinePaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost(?\Kiboko\Magento\V2_3\Model\V1CartsMinePaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineSelectedPaymentMethodPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quotePaymentMethodManagementV1SetPut(?\Kiboko\Magento\V2_3\Model\V1CartsMineSelectedPaymentMethodPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuotePaymentMethodManagementV1SetPut($requestBody), $fetch);
    }
    /**
     * Set payment information for a specified cart.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineSetPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutPaymentInformationManagementV1SavePaymentInformationPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineSetPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutPaymentInformationManagementV1SavePaymentInformationPost($requestBody), $fetch);
    }
    /**
     *
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineShippingInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CheckoutDataPaymentDetailsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost(?\Kiboko\Magento\V2_3\Model\V1CartsMineShippingInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutShippingInformationManagementV1SaveAddressInformationPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsMineTotalsInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CheckoutTotalsInformationManagementV1CalculatePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataTotalsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutTotalsInformationManagementV1CalculatePost(?\Kiboko\Magento\V2_3\Model\V1CartsMineTotalsInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutTotalsInformationManagementV1CalculatePost($requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteCartManagementV1AssignCustomerPutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteCartManagementV1AssignCustomerPut(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteCartManagementV1AssignCustomerPut($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdBillingAddressBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdBillingAddressUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataAddressInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdBillingAddress(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdBillingAddress($cartId), $fetch);
    }
    /**
     * Assigns a specified billing address to a specified cart.
     *
     * @param int $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdBillingAddressPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdBillingAddressBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdBillingAddressUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdBillingAddress(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdBillingAddressPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdBillingAddress($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DeleteV1CartsByCartIdCouponBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\DeleteV1CartsByCartIdCouponUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function deleteV1CartsByCartIdCoupon(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DeleteV1CartsByCartIdCoupon($cartId), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdCouponBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdCouponUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdCoupon(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdCoupon($cartId), $fetch);
    }
    /**
     * Adds a coupon by code to a specified cart.
     *
     ...
     * @param string $couponCode The coupon code data.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdCouponByCouponCodeBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdCouponByCouponCodeUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function putV1CartsByCartIdCouponByCouponCode(int $cartId, string $couponCode, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PutV1CartsByCartIdCouponByCouponCode($cartId, $couponCode), $fetch);
    }
    /**
     * Estimate shipping by address and return list of available shipping methods
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdEstimateShippingMethods(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdEstimateShippingMethods($cartId, $requestBody), $fetch);
    }
    /**
     * Estimate shipping
     *
     * @param int $cartId The shopping cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdEstimateShippingMethodsByAddressIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdEstimateShippingMethodsByAddressIdUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdEstimateShippingMethodsByAddressId(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdEstimateShippingMethodsByAddressIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdEstimateShippingMethodsByAddressId($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $cartId The shopping cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdGiftMessageUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\GiftMessageDataMessageInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdGiftMessage(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdGiftMessage($cartId), $fetch);
    }
    /**
     * Set the gift message for an entire order.
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdGiftMessage(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdGiftMessagePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdGiftMessage($cartId, $requestBody), $fetch);
    }
    /**
     * Return the gift message for a specified item in a specified shopping cart.
     *
     ...
     * @param int $itemId The item ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdGiftMessageByItemIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdGiftMessageByItemIdUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\GiftMessageDataMessageInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdGiftMessageByItemId(int $cartId, int $itemId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdGiftMessageByItemId($cartId, $itemId), $fetch);
    }
    /**
     * Set the gift message for a specified item in a specified shopping cart.
     *
     * @param int $cartId The cart ID.
     * @param int $itemId The item ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdGiftMessageItemIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdGiftMessageByItemIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdGiftMessageByItemIdUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdGiftMessageByItemId(int $cartId, int $itemId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdGiftMessageItemIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdGiftMessageByItemId($cartId, $itemId, $requestBody), $fetch);
    }
    /**
     *
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftCardAccountGiftCardAccountManagementV1SaveByQuoteIdPut(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdGiftCardsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftCardAccountGiftCardAccountManagementV1SaveByQuoteIdPut($cartId, $requestBody), $fetch);
    }
    /**
     * Remove GiftCard Account entity
     *
     ...
     * @param string $giftCardCode
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DeleteV1CartsByCartIdGiftCardByGiftCardCodeUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DeleteV1CartsByCartIdGiftCardByGiftCardCode($cartId, $giftCardCode), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdItemsBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdItemsUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdItems(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdItems($cartId), $fetch);
    }
    /**
     * Removes the specified item from the specified cart.
     *
     ...
     * @param int $itemId The item ID of the item to be removed.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DeleteV1CartsByCartIdItemByItemIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\DeleteV1CartsByCartIdItemByItemIdUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function deleteV1CartsByCartIdItemByItemId(int $cartId, int $itemId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DeleteV1CartsByCartIdItemByItemId($cartId, $itemId), $fetch);
    }
    /**
     * Add/update the specified cart item.
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function putV1CartsByCartIdItemByItemId(string $cartId, string $itemId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdItemsItemIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PutV1CartsByCartIdItemByItemId($cartId, $itemId, $requestBody), $fetch);
    }
    /**
     * Places an order for a specified cart.
     *
     * @param int $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdOrderPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdOrderBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdOrderUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function putV1CartsByCartIdOrder(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdOrderPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PutV1CartsByCartIdOrder($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdPaymentMethodsBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdPaymentMethodsUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataPaymentMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdPaymentMethods(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdPaymentMethods($cartId), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdSelectedPaymentMethodBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdSelectedPaymentMethodUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataPaymentInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdSelectedPaymentMethod(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdSelectedPaymentMethod($cartId), $fetch);
    }
    /**
     * Adds a specified payment method to a specified shopping cart.
     *
     * @param int $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdSelectedPaymentMethodPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdSelectedPaymentMethodBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CartsByCartIdSelectedPaymentMethodUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function putV1CartsByCartIdSelectedPaymentMethod(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdSelectedPaymentMethodPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PutV1CartsByCartIdSelectedPaymentMethod($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdShippingInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdShippingInformationUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CheckoutDataPaymentDetailsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdShippingInformation(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdShippingInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdShippingInformation($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $cartId The shopping cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdShippingMethodsBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdShippingMethodsUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdShippingMethods(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdShippingMethods($cartId), $fetch);
    }
    /**
     ...
     * @param int $cartId The cart ID.
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdTotalBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CartsByCartIdTotalUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataTotalsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CartsByCartIdTotal(int $cartId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CartsByCartIdTotal($cartId), $fetch);
    }
    /**
     * Calculate quote totals based on address and shipping method.
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsCartIdTotalsInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByCartIdTotalsInformationUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataTotalsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByCartIdTotalsInformation(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1CartsCartIdTotalsInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByCartIdTotalsInformation($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1CartsQuoteIdItemsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByQuoteIdItemBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PostV1CartsByQuoteIdItemUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function postV1CartsByQuoteIdItem(string $quoteId, ?\Kiboko\Magento\V2_3\Model\V1CartsQuoteIdItemsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CartsByQuoteIdItem($quoteId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CategoriesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogCategoryRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CategoriesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCategoryRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCategoryManagementV1MovePut(int $categoryId, ?\Kiboko\Magento\V2_3\Model\V1CategoriesCategoryIdMovePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCategoryManagementV1MovePut($categoryId, $requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1CategoriesCategoryIdProductsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCategoryLinkRepositoryV1SavePost(string $categoryId, ?\Kiboko\Magento\V2_3\Model\V1CategoriesCategoryIdProductsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCategoryLinkRepositoryV1SavePost($categoryId, $requestBody), $fetch);
    }
    /**
     * Assign a product to the required category
     *
     * @param string $categoryId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CategoriesCategoryIdProductsPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCategoryLinkRepositoryV1SavePut(string $categoryId, ?\Kiboko\Magento\V2_3\Model\V1CategoriesCategoryIdProductsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCategoryLinkRepositoryV1SavePut($categoryId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1CategoriesIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataCategoryInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCategoryRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CategoriesIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCategoryRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Save block.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CmsBlockPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function cmsBlockRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CmsBlockPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CmsBlockRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1CmsBlockIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CmsDataBlockInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function cmsBlockRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CmsBlockIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CmsBlockRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Save page.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CmsPagePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function cmsPageRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CmsPagePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CmsPageRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1CmsPageIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CmsDataPageInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function cmsPageRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CmsPageIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CmsPageRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Delete page by ID.
     *
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function companyCompanyRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CompanyPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCompanyRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Change a role for a company user.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyAssignRolesPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyAclV1AssignRolesPut(?\Kiboko\Magento\V2_3\Model\V1CompanyAssignRolesPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyAclV1AssignRolesPut($requestBody), $fetch);
    }
    /**
     ...
     */
    public function companyRoleRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CompanyRolePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyRoleRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Create or update a role for a selected company.
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyRoleIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CompanyDataRoleInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyRoleRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CompanyRoleIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyRoleRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Delete a role.
     *
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyCompanyIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CompanyDataCompanyInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCompanyRepositoryV1SavePut(string $companyId, ?\Kiboko\Magento\V2_3\Model\V1CompanyCompanyIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCompanyRepositoryV1SavePut($companyId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $historyId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyCreditsHistoryHistoryIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCreditCreditHistoryManagementV1UpdatePut(int $historyId, ?\Kiboko\Magento\V2_3\Model\V1CompanyCreditsHistoryHistoryIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCreditCreditHistoryManagementV1UpdatePut($historyId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $creditId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyCreditsCreditIdDecreaseBalancePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CompanyCreditCreditBalanceManagementV1DecreasePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCreditCreditBalanceManagementV1DecreasePost(int $creditId, ?\Kiboko\Magento\V2_3\Model\V1CompanyCreditsCreditIdDecreaseBalancePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCreditCreditBalanceManagementV1DecreasePost($creditId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $creditId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CompanyCreditsCreditIdIncreaseBalancePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CompanyCreditCreditBalanceManagementV1IncreasePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCreditCreditBalanceManagementV1IncreasePost(int $creditId, ?\Kiboko\Magento\V2_3\Model\V1CompanyCreditsCreditIdIncreaseBalancePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCreditCreditBalanceManagementV1IncreasePost($creditId, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CompanyCreditDataCreditLimitInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCreditCreditLimitRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CompanyCreditsIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCreditCreditLimitRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Generate variation based on same product
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsVariationPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function configurableProductConfigurableProductManagementV1GenerateVariationPut(?\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsVariationPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\ConfigurableProductConfigurableProductManagementV1GenerateVariationPut($requestBody), $fetch);
    }
    /**
     *
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuChildPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\ConfigurableProductLinkManagementV1AddChildPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function configurableProductLinkManagementV1AddChildPost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuChildPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\ConfigurableProductLinkManagementV1AddChildPost($sku, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuOptionsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function configurableProductOptionRepositoryV1SavePost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuOptionsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\ConfigurableProductOptionRepositoryV1SavePost($sku, $requestBody), $fetch);
    }
    /**
     ...
     * @param string $sku
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuOptionsIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function configurableProductOptionRepositoryV1SavePut(string $sku, string $id, ?\Kiboko\Magento\V2_3\Model\V1ConfigurableProductsSkuOptionsIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\ConfigurableProductOptionRepositoryV1SavePut($sku, $id, $requestBody), $fetch);
    }
    /**
     * Save a coupon.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CouponsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesRuleCouponRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CouponsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleCouponRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Delete coupon by coupon codes.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CouponsDeleteByCodesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesRuleCouponManagementV1DeleteByCodesPost(?\Kiboko\Magento\V2_3\Model\V1CouponsDeleteByCodesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleCouponManagementV1DeleteByCodesPost($requestBody), $fetch);
    }
    /**
     * Delete coupon by coupon ids.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CouponsDeleteByIdsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\SalesRuleDataCouponMassDeleteResultInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRuleCouponManagementV1DeleteByIdsPost(?\Kiboko\Magento\V2_3\Model\V1CouponsDeleteByIdsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleCouponManagementV1DeleteByIdsPost($requestBody), $fetch);
    }
    /**
     * Generate coupon for a rule
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CouponsGeneratePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRuleCouponManagementV1GeneratePost(?\Kiboko\Magento\V2_3\Model\V1CouponsGeneratePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleCouponManagementV1GeneratePost($requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1CouponsCouponIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\SalesRuleDataCouponInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRuleCouponRepositoryV1SavePut(string $couponId, ?\Kiboko\Magento\V2_3\Model\V1CouponsCouponIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleCouponRepositoryV1SavePut($couponId, $requestBody), $fetch);
    }
    /**
     * Performs persist operations for a specified credit memo.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CreditmemoPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesCreditmemoRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CreditmemoPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesCreditmemoRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Prepare creditmemo to refund and save it.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CreditmemoRefundPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesCreditmemoManagementV1RefundPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\SalesDataCreditmemoInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesCreditmemoManagementV1RefundPost(?\Kiboko\Magento\V2_3\Model\V1CreditmemoRefundPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesCreditmemoManagementV1RefundPost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1CreditmemoIdCommentsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesCreditmemoCommentRepositoryV1SavePost(string $id, ?\Kiboko\Magento\V2_3\Model\V1CreditmemoIdCommentsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesCreditmemoCommentRepositoryV1SavePost($id, $requestBody), $fetch);
    }
    /**
     ...
     * Save customer group.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomerGroupsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function customerGroupRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1CustomerGroupsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerGroupRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * @param int $storeId
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerGroupsDefaultByStoreIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerGroupsDefaultByStoreIdUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerGroupsDefaultByStoreIdInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataGroupInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CustomerGroupsDefaultByStoreId(int $storeId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CustomerGroupsDefaultByStoreId($storeId), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataGroupInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerGroupRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1CustomerGroupsIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerGroupRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerAccountManagementV1CreateAccountPostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1CreateAccountPost(?\Kiboko\Magento\V2_3\Model\V1CustomersPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1CreateAccountPost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersConfirmPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1ResendConfirmationPost(?\Kiboko\Magento\V2_3\Model\V1CustomersConfirmPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ResendConfirmationPost($requestBody), $fetch);
    }
    /**
     * Check if given email is associated with a customer account in given website.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersIsEmailAvailablePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerAccountManagementV1IsEmailAvailablePostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1IsEmailAvailablePost(?\Kiboko\Magento\V2_3\Model\V1CustomersIsEmailAvailablePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1IsEmailAvailablePost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersMePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerCustomerRepositoryV1SavePut(?\Kiboko\Magento\V2_3\Model\V1CustomersMePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerCustomerRepositoryV1SavePut($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1ActivateByIdPut(?\Kiboko\Magento\V2_3\Model\V1CustomersMeActivatePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ActivateByIdPut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersMePasswordPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1ChangePasswordByIdPut(?\Kiboko\Magento\V2_3\Model\V1CustomersMePasswordPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ChangePasswordByIdPut($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersPasswordPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerAccountManagementV1InitiatePasswordResetPutInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1InitiatePasswordResetPut(?\Kiboko\Magento\V2_3\Model\V1CustomersPasswordPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1InitiatePasswordResetPut($requestBody), $fetch);
    }
    /**
     * Reset customer password.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersResetPasswordPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CustomerAccountManagementV1ResetPasswordPostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1ResetPasswordPost(?\Kiboko\Magento\V2_3\Model\V1CustomersResetPasswordPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ResetPasswordPost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersValidatePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function customerAccountManagementV1ValidatePut(?\Kiboko\Magento\V2_3\Model\V1CustomersValidatePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ValidatePut($requestBody), $fetch);
    }
    /**
     ...
     * @param int $customerId
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerByCustomerIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerByCustomerIdUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomerByCustomerIdInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CustomerByCustomerId(int $customerId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CustomerByCustomerId($customerId), $fetch);
    }
    /**
     * Create or update a customer.
     *
     * @param string $customerId
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersCustomerIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CustomerByCustomerIdBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CustomerByCustomerIdUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\PutV1CustomerByCustomerIdInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function putV1CustomerByCustomerId(string $customerId, ?\Kiboko\Magento\V2_3\Model\V1CustomersCustomerIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PutV1CustomerByCustomerId($customerId, $requestBody), $fetch);
    }
    /**
     ...
     * @param int $customerId
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdBillingAddressBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdBillingAddressUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdBillingAddressInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataAddressInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CustomersByCustomerIdBillingAddress(int $customerId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CustomersByCustomerIdBillingAddress($customerId), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\PostV1CustomersByCustomerIdCart($customerId), $fetch);
    }
    /**
     ...
     * @param int $customerId
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdShippingAddressBadRequestException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdShippingAddressUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\GetV1CustomersByCustomerIdShippingAddressInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataAddressInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function getV1CustomersByCustomerIdShippingAddress(int $customerId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GetV1CustomersByCustomerIdShippingAddress($customerId), $fetch);
    }
    /**
     * Activate a customer account using a key that was sent in a confirmation email.
     *
     * @param string $email
     * @param null|\Kiboko\Magento\V2_3\Model\V1CustomersEmailActivatePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CustomerDataCustomerInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function customerAccountManagementV1ActivatePut(string $email, ?\Kiboko\Magento\V2_3\Model\V1CustomersEmailActivatePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CustomerAccountManagementV1ActivatePut($email, $requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1EavAttributeSetsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function eavAttributeSetManagementV1CreatePost(?\Kiboko\Magento\V2_3\Model\V1EavAttributeSetsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\EavAttributeSetManagementV1CreatePost($requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1EavAttributeSetsAttributeSetIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\EavDataAttributeSetInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function eavAttributeSetRepositoryV1SavePut(string $attributeSetId, ?\Kiboko\Magento\V2_3\Model\V1EavAttributeSetsAttributeSetIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\EavAttributeSetRepositoryV1SavePut($attributeSetId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1GiftWrappingsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function giftWrappingWrappingRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1GiftWrappingsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftWrappingWrappingRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1GiftWrappingsWrappingIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\GiftWrappingDataWrappingInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftWrappingWrappingRepositoryV1SavePut(string $wrappingId, ?\Kiboko\Magento\V2_3\Model\V1GiftWrappingsWrappingIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftWrappingWrappingRepositoryV1SavePut($wrappingId, $requestBody), $fetch);
    }
    /**
     * Estimate shipping
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1GiftregistryMineEstimateShippingMethodsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftRegistryShippingMethodManagementV1EstimateByRegistryIdPost(?\Kiboko\Magento\V2_3\Model\V1GiftregistryMineEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftRegistryShippingMethodManagementV1EstimateByRegistryIdPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestCartManagementV1AssignCustomerPutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestCartManagementV1AssignCustomerPut(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestCartManagementV1AssignCustomerPut($cartId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdBillingAddressPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestBillingAddressManagementV1AssignPostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestBillingAddressManagementV1AssignPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdBillingAddressPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestBillingAddressManagementV1AssignPost($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCheckoutFieldsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingQuoteGuestCartCheckoutFieldManagementV1SaveCheckoutFieldsPostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingQuoteGuestCartCheckoutFieldManagementV1SaveCheckoutFieldsPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCheckoutFieldsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingQuoteGuestCartCheckoutFieldManagementV1SaveCheckoutFieldsPost($cartId, $requestBody), $fetch);
    }
    /**
     * Set shipping/billing methods and additional data for cart and collect totals for guest.
     *
     * @param string $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCollectTotalsPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataTotalsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestCartTotalManagementV1CollectTotalsPut(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCollectTotalsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestCartTotalManagementV1CollectTotalsPut($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param string $cartId
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1DeleteSearchRequestDeleteInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1DeleteSearchRequestDelete($cartId), $fetch);
    }
    /**
     *
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\TemandoShippingDataCollectionPointSearchRequestInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingCollectionPointGuestCartCollectionPointManagementV1SaveSearchRequestPut(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCollectionPointSearchRequestPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1SaveSearchRequestPut($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1GetCollectionPointsGet($cartId), $fetch);
    }
    /**
     *
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCollectionPointSelectPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1SelectCollectionPointPostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingCollectionPointGuestCartCollectionPointManagementV1SelectCollectionPointPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdCollectionPointSelectPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingCollectionPointGuestCartCollectionPointManagementV1SelectCollectionPointPost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdDeliveryOptionPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingQuoteGuestCartDeliveryOptionManagementV1SavePostInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingQuoteGuestCartDeliveryOptionManagementV1SavePost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdDeliveryOptionPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingQuoteGuestCartDeliveryOptionManagementV1SavePost($cartId, $requestBody), $fetch);
    }
    /**
     * Estimate shipping by address and return list of available shipping methods
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdEstimateShippingMethodsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestShipmentEstimationV1EstimateByExtendedAddressPost($cartId, $requestBody), $fetch);
    }
    /**
     * Return the gift message for a specified order.
     *
     ...
     *
     * @param string $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdGiftMessagePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GiftMessageGuestCartRepositoryV1SavePostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftMessageGuestCartRepositoryV1SavePost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdGiftMessagePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftMessageGuestCartRepositoryV1SavePost($cartId, $requestBody), $fetch);
    }
    /**
     * Return the gift message for a specified item in a specified shopping cart.
     *
     ...
     * @param string $cartId The cart ID.
     * @param int $itemId The item ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdGiftMessageItemIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\GiftMessageGuestItemRepositoryV1SavePostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftMessageGuestItemRepositoryV1SavePost(string $cartId, int $itemId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdGiftMessageItemIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftMessageGuestItemRepositoryV1SavePost($cartId, $itemId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdItemsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestCartItemRepositoryV1SavePostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestCartItemRepositoryV1SavePost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdItemsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestCartItemRepositoryV1SavePost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @param string $cartId
     * @param string $itemId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdItemsItemIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestCartItemRepositoryV1SavePutBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataCartItemInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestCartItemRepositoryV1SavePut(string $cartId, string $itemId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdItemsItemIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestCartItemRepositoryV1SavePut($cartId, $itemId, $requestBody), $fetch);
    }
    /**
     * Place an order for a specified cart.
     *
     * @param string $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdOrderPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestCartManagementV1PlaceOrderPutBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestCartManagementV1PlaceOrderPut(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdOrderPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestCartManagementV1PlaceOrderPut($cartId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdSelectedPaymentMethodPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\QuoteGuestPaymentMethodManagementV1SetPutBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function quoteGuestPaymentMethodManagementV1SetPut(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdSelectedPaymentMethodPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\QuoteGuestPaymentMethodManagementV1SetPut($cartId, $requestBody), $fetch);
    }
    /**
     * Set payment information for a specified cart.
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdSetPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutGuestPaymentInformationManagementV1SavePaymentInformationPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdSetPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPost($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdShippingInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CheckoutDataPaymentDetailsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutGuestShippingInformationManagementV1SaveAddressInformationPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdShippingInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutGuestShippingInformationManagementV1SaveAddressInformationPost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdTotalsInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataTotalsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function checkoutGuestTotalsInformationManagementV1CalculatePost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestCartsCartIdTotalsInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CheckoutGuestTotalsInformationManagementV1CalculatePost($cartId, $requestBody), $fetch);
    }
    /**
     * Estimate shipping
     *
     * @param string $cartId The shopping cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1GuestGiftregistryCartIdEstimateShippingMethodsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function giftRegistryGuestCartShippingMethodManagementV1EstimateByRegistryIdPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1GuestGiftregistryCartIdEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\GiftRegistryGuestCartShippingMethodManagementV1EstimateByRegistryIdPost($cartId, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyCompanyHierarchyV1MoveNodePut(int $id, ?\Kiboko\Magento\V2_3\Model\V1HierarchyMoveIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyCompanyHierarchyV1MoveNodePut($id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1IntegrationAdminTokenPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function integrationAdminTokenServiceV1CreateAdminAccessTokenPost(?\Kiboko\Magento\V2_3\Model\V1IntegrationAdminTokenPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\IntegrationAdminTokenServiceV1CreateAdminAccessTokenPost($requestBody), $fetch);
    }
    /**
     * Create access token for admin given the customer credentials.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1IntegrationCustomerTokenPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPostBadRequestException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function integrationCustomerTokenServiceV1CreateCustomerAccessTokenPost(?\Kiboko\Magento\V2_3\Model\V1IntegrationCustomerTokenPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPost($requestBody), $fetch);
    }
    /**
     * Create refund for invoice
     *
     * @param int $invoiceId
     * @param null|\Kiboko\Magento\V2_3\Model\V1InvoiceInvoiceIdRefundPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesRefundInvoiceV1ExecutePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRefundInvoiceV1ExecutePost(int $invoiceId, ?\Kiboko\Magento\V2_3\Model\V1InvoiceInvoiceIdRefundPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRefundInvoiceV1ExecutePost($invoiceId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1InvoicesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesInvoiceRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1InvoicesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesInvoiceRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Performs persist operations for a specified invoice comment.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1InvoicesCommentsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesInvoiceCommentRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1InvoicesCommentsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesInvoiceCommentRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $cartId The cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdBillingAddressPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteBillingAddressManagementV1AssignPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdBillingAddressPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteBillingAddressManagementV1AssignPost($cartId, $requestBody), $fetch);
    }
    /**
     * Deletes a coupon from a specified cart.
     *
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdEstimateShippingMethodsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteShipmentEstimationV1EstimateByExtendedAddressPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdEstimateShippingMethodsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteShipmentEstimationV1EstimateByExtendedAddressPost($cartId, $requestBody), $fetch);
    }
    /**
     * Estimate shipping
     *
     * @param int $cartId The shopping cart ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdEstimateShippingMethodsByAddressIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\QuoteDataShippingMethodInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteShippingMethodManagementV1EstimateByAddressIdPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdEstimateShippingMethodsByAddressIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteShippingMethodManagementV1EstimateByAddressIdPost($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdGiftCardsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\NegotiableQuoteGiftCardAccountManagementV1SaveByQuoteIdPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteGiftCardAccountManagementV1SaveByQuoteIdPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdGiftCardsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteGiftCardAccountManagementV1SaveByQuoteIdPost($cartId, $requestBody), $fetch);
    }
    /**
     * Remove GiftCard Account entity
     *
     ...
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuotePaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuotePaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost($cartId, $requestBody), $fetch);
    }
    /**
     * Set payment information for a specified cart.
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdSetPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuotePaymentInformationManagementV1SavePaymentInformationPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdSetPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuotePaymentInformationManagementV1SavePaymentInformationPost($cartId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param int $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdShippingInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CheckoutDataPaymentDetailsInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteShippingInformationManagementV1SaveAddressInformationPost(int $cartId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableCartsCartIdShippingInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteShippingInformationManagementV1SaveAddressInformationPost($cartId, $requestBody), $fetch);
    }
    /**
     * Returns quote totals data for a specified cart.
     *
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteDeclinePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\NegotiableQuoteNegotiableQuoteManagementV1DeclinePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableQuoteManagementV1DeclinePost(?\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteDeclinePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableQuoteManagementV1DeclinePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuotePricesUpdatedPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableQuotePriceManagementV1PricesUpdatedPost(?\Kiboko\Magento\V2_3\Model\V1NegotiableQuotePricesUpdatedPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableQuotePriceManagementV1PricesUpdatedPost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteRequestPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\NegotiableQuoteNegotiableQuoteManagementV1CreatePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableQuoteManagementV1CreatePost(?\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteRequestPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableQuoteManagementV1CreatePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteSubmitToCustomerPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\NegotiableQuoteNegotiableQuoteManagementV1AdminSendPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableQuoteManagementV1AdminSendPost(?\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteSubmitToCustomerPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableQuoteManagementV1AdminSendPost($requestBody), $fetch);
    }
    /**
     * Save quote
     *
     * @param string $quoteId
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteQuoteIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\NegotiableQuoteNegotiableCartRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableCartRepositoryV1SavePut(string $quoteId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteQuoteIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableCartRepositoryV1SavePut($quoteId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $quoteId Negotiable Quote id
     * @param null|\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function negotiableQuoteNegotiableQuoteShippingManagementV1SetShippingMethodPut(int $quoteId, ?\Kiboko\Magento\V2_3\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\NegotiableQuoteNegotiableQuoteShippingManagementV1SetShippingMethodPut($quoteId, $requestBody), $fetch);
    }
    /**
     *
     *
     * @param int $orderId
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrderOrderIdInvoicePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesInvoiceOrderV1ExecutePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesInvoiceOrderV1ExecutePost(int $orderId, ?\Kiboko\Magento\V2_3\Model\V1OrderOrderIdInvoicePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesInvoiceOrderV1ExecutePost($orderId, $requestBody), $fetch);
    }
    /**
     * Create offline refund for order
     *
     * @param int $orderId
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrderOrderIdRefundPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesRefundOrderV1ExecutePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRefundOrderV1ExecutePost(int $orderId, ?\Kiboko\Magento\V2_3\Model\V1OrderOrderIdRefundPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRefundOrderV1ExecutePost($orderId, $requestBody), $fetch);
    }
    /**
     * Creates new Shipment for given Order.
     *
     * @param int $orderId
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrderOrderIdShipPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesShipOrderV1ExecutePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesShipOrderV1ExecutePost(int $orderId, ?\Kiboko\Magento\V2_3\Model\V1OrderOrderIdShipPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesShipOrderV1ExecutePost($orderId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrdersPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesOrderRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1OrdersPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesOrderRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Performs persist operations for a specified order.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrdersCreatePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesOrderRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\SalesDataOrderInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesOrderRepositoryV1SavePut(?\Kiboko\Magento\V2_3\Model\V1OrdersCreatePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesOrderRepositoryV1SavePut($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $id The order ID.
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrdersIdCommentsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SalesOrderManagementV1AddCommentPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesOrderManagementV1AddCommentPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1OrdersIdCommentsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesOrderManagementV1AddCommentPost($id, $requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1OrdersParentIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesOrderAddressRepositoryV1SavePut(string $parentId, ?\Kiboko\Magento\V2_3\Model\V1OrdersParentIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesOrderAddressRepositoryV1SavePut($parentId, $requestBody), $fetch);
    }
    /**
     * Get product list
     *
     ...
     * Create product
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataProductInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ProductsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * Create attribute set from data
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\EavDataAttributeSetInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogAttributeSetManagementV1CreatePost(?\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogAttributeSetManagementV1CreatePost($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeManagementV1AssignPost(?\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsAttributesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeManagementV1AssignPost($requestBody), $fetch);
    }
    /**
     * Save attribute group
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsGroupsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogProductAttributeGroupRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsGroupsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeGroupRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\EavDataAttributeSetInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogAttributeSetRepositoryV1SavePut(string $attributeSetId, ?\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsAttributeSetIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogAttributeSetRepositoryV1SavePut($attributeSetId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $attributeSetId
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsAttributeSetIdGroupsPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CatalogProductAttributeGroupRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\EavDataAttributeGroupInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeGroupRepositoryV1SavePut(string $attributeSetId, ?\Kiboko\Magento\V2_3\Model\V1ProductsAttributeSetsAttributeSetIdGroupsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeGroupRepositoryV1SavePut($attributeSetId, $requestBody), $fetch);
    }
    /**
     * Retrieve all attributes for entity type
     *
     ...
     * Save attribute data
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataProductAttributeInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ProductsAttributesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param string $attributeCode
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributesAttributeCodePutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataProductAttributeInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeRepositoryV1SavePut(string $attributeCode, ?\Kiboko\Magento\V2_3\Model\V1ProductsAttributesAttributeCodePutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeRepositoryV1SavePut($attributeCode, $requestBody), $fetch);
    }
    /**
     * Retrieve list of attribute options
     *
     ...
     *
     * @param string $attributeCode
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsAttributesAttributeCodeOptionsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeOptionManagementV1AddPost(string $attributeCode, ?\Kiboko\Magento\V2_3\Model\V1ProductsAttributesAttributeCodeOptionsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeOptionManagementV1AddPost($attributeCode, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsBasePricesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogBasePriceStorageV1UpdatePost(?\Kiboko\Magento\V2_3\Model\V1ProductsBasePricesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogBasePriceStorageV1UpdatePost($requestBody), $fetch);
    }
    /**
     * Return product prices. In case of at least one of skus is not found exception will be thrown.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsBasePricesInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogBasePriceStorageV1GetPost(?\Kiboko\Magento\V2_3\Model\V1ProductsBasePricesInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogBasePriceStorageV1GetPost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsCostPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CatalogCostStorageV1UpdatePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCostStorageV1UpdatePost(?\Kiboko\Magento\V2_3\Model\V1ProductsCostPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCostStorageV1UpdatePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsCostDeletePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogCostStorageV1DeletePost(?\Kiboko\Magento\V2_3\Model\V1ProductsCostDeletePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCostStorageV1DeletePost($requestBody), $fetch);
    }
    /**
     * Return product prices. In case of at least one of skus is not found exception will be thrown.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsCostInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogCostStorageV1GetPost(?\Kiboko\Magento\V2_3\Model\V1ProductsCostInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogCostStorageV1GetPost($requestBody), $fetch);
    }
    /**
     ...
     * Save Custom Option
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsOptionsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogProductCustomOptionRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ProductsOptionsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductCustomOptionRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     *
     * @param string $optionId
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsOptionsOptionIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CatalogProductCustomOptionRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataProductCustomOptionInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductCustomOptionRepositoryV1SavePut(string $optionId, ?\Kiboko\Magento\V2_3\Model\V1ProductsOptionsOptionIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductCustomOptionRepositoryV1SavePut($optionId, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogSpecialPriceStorageV1UpdatePost(?\Kiboko\Magento\V2_3\Model\V1ProductsSpecialPricePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogSpecialPriceStorageV1UpdatePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSpecialPriceDeletePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogSpecialPriceStorageV1DeletePost(?\Kiboko\Magento\V2_3\Model\V1ProductsSpecialPriceDeletePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogSpecialPriceStorageV1DeletePost($requestBody), $fetch);
    }
    /**
     * Return product's special price. In case of at least one of skus is not found exception will be thrown.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSpecialPriceInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogSpecialPriceStorageV1GetPost(?\Kiboko\Magento\V2_3\Model\V1ProductsSpecialPriceInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogSpecialPriceStorageV1GetPost($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogTierPriceStorageV1UpdatePost(?\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogTierPriceStorageV1UpdatePost($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogTierPriceStorageV1ReplacePut(?\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogTierPriceStorageV1ReplacePut($requestBody), $fetch);
    }
    /**
     * Delete product tier prices. If any items will have invalid price, price type, website id, sku, customer group or quantity, they will be marked as failed and excluded from delete list and \Magento\Catalog\Api\Data\PriceUpdateResultInterface[] with problem description will be returned. If there were no failed items during update empty array will be returned. If error occurred during the update exception will be thrown.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesDeletePostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\CatalogTierPriceStorageV1DeletePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataPriceUpdateResultInterface[]|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogTierPriceStorageV1DeletePost(?\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesDeletePostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogTierPriceStorageV1DeletePost($requestBody), $fetch);
    }
    /**
     * Return product prices. In case of at least one of skus is not found exception will be thrown.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function catalogTierPriceStorageV1GetPost(?\Kiboko\Magento\V2_3\Model\V1ProductsTierPricesInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogTierPriceStorageV1GetPost($requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @param string $productSku
     * @param string $itemId
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsProductSkuStockItemsItemIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogInventoryStockRegistryV1UpdateStockItemBySkuPut(string $productSku, string $itemId, ?\Kiboko\Magento\V2_3\Model\V1ProductsProductSkuStockItemsItemIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogInventoryStockRegistryV1UpdateStockItemBySkuPut($productSku, $itemId, $requestBody), $fetch);
    }
    /**
     *
     *
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\CatalogDataProductInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductRepositoryV1SavePut(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductRepositoryV1SavePut($sku, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DownloadableLinkRepositoryV1SavePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function downloadableLinkRepositoryV1SavePost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DownloadableLinkRepositoryV1SavePost($sku, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksSamplesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DownloadableSampleRepositoryV1SavePostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function downloadableSampleRepositoryV1SavePost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksSamplesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DownloadableSampleRepositoryV1SavePost($sku, $requestBody), $fetch);
    }
    /**
     * Update downloadable sample of the given product
     *
     * @param string $sku
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksSamplesIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DownloadableSampleRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function downloadableSampleRepositoryV1SavePut(string $sku, string $id, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksSamplesIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DownloadableSampleRepositoryV1SavePut($sku, $id, $requestBody), $fetch);
    }
    /**
     * Update downloadable link of the given product (link type and its resources cannot be changed)
     *
     * @param string $sku
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\DownloadableLinkRepositoryV1SavePutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function downloadableLinkRepositoryV1SavePut(string $sku, string $id, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuDownloadableLinksIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\DownloadableLinkRepositoryV1SavePut($sku, $id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuLinksPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductLinkManagementV1SetProductLinksPost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuLinksPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductLinkManagementV1SetProductLinksPost($sku, $requestBody), $fetch);
    }
    /**
     * Save product link
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuLinksPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductLinkRepositoryV1SavePut(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuLinksPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductLinkRepositoryV1SavePut($sku, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuMediaPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeMediaGalleryManagementV1CreatePost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuMediaPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeMediaGalleryManagementV1CreatePost($sku, $requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuMediaEntryIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductAttributeMediaGalleryManagementV1UpdatePut(string $sku, string $entryId, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuMediaEntryIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductAttributeMediaGalleryManagementV1UpdatePut($sku, $entryId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $sku
     * @param null|\Kiboko\Magento\V2_3\Model\V1ProductsSkuWebsitesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductWebsiteLinkRepositoryV1SavePost(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuWebsitesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductWebsiteLinkRepositoryV1SavePost($sku, $requestBody), $fetch);
    }
    /**
     * Assign a product to the website
     *
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function catalogProductWebsiteLinkRepositoryV1SavePut(string $sku, ?\Kiboko\Magento\V2_3\Model\V1ProductsSkuWebsitesPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CatalogProductWebsiteLinkRepositoryV1SavePut($sku, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1RequisitionListsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\RequisitionListRequisitionListRepositoryV1SavePostBadRequestException
     ...
     */
    public function requisitionListRequisitionListRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1RequisitionListsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RequisitionListRequisitionListRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * Save RMA
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ReturnsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function rmaRmaManagementV1SaveRmaPost(?\Kiboko\Magento\V2_3\Model\V1ReturnsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RmaRmaManagementV1SaveRmaPost($requestBody), $fetch);
    }
    /**
     * Delete RMA
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ReturnsIdDeleteBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function rmaRmaRepositoryV1DeleteDelete(string $id, ?\Kiboko\Magento\V2_3\Model\V1ReturnsIdDeleteBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RmaRmaRepositoryV1DeleteDelete($id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ReturnsIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\RmaRmaManagementV1SaveRmaPutUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\RmaDataRmaInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function rmaRmaManagementV1SaveRmaPut(string $id, ?\Kiboko\Magento\V2_3\Model\V1ReturnsIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RmaRmaManagementV1SaveRmaPut($id, $requestBody), $fetch);
    }
    /**
     * Comments list
     *
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ReturnsIdCommentsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function rmaCommentManagementV1AddCommentPost(string $id, ?\Kiboko\Magento\V2_3\Model\V1ReturnsIdCommentsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RmaCommentManagementV1AddCommentPost($id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ReturnsIdTrackingNumbersPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\RmaTrackManagementV1AddTrackPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function rmaTrackManagementV1AddTrackPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1ReturnsIdTrackingNumbersPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\RmaTrackManagementV1AddTrackPost($id, $requestBody), $fetch);
    }
    /**
     * Remove track by id
     *
     ...
     * Save sales rule.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1SalesRulesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesRuleRuleRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1SalesRulesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleRuleRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $ruleId
     * @param null|\Kiboko\Magento\V2_3\Model\V1SalesRulesRuleIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\SalesRuleDataRuleInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function salesRuleRuleRepositoryV1SavePut(string $ruleId, ?\Kiboko\Magento\V2_3\Model\V1SalesRulesRuleIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesRuleRuleRepositoryV1SavePut($ruleId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogSharedCatalogRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1SharedCatalogPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogSharedCatalogRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogSharedCatalogRepositoryV1SavePut(string $id, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogSharedCatalogRepositoryV1SavePut($id, $requestBody), $fetch);
    }
    /**
     * Add categories into the shared catalog.
     *
     * @param int $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdAssignCategoriesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogCategoryManagementV1AssignCategoriesPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdAssignCategoriesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogCategoryManagementV1AssignCategoriesPost($id, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogProductManagementV1AssignProductsPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdAssignProductsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogProductManagementV1AssignProductsPost($id, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdUnassignCategoriesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogCategoryManagementV1UnassignCategoriesPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdUnassignCategoriesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogCategoryManagementV1UnassignCategoriesPost($id, $requestBody), $fetch);
    }
    /**
     * Remove the specified products from the shared catalog.
     *
     * @param int $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdUnassignProductsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\SharedCatalogProductManagementV1UnassignProductsPostUnauthorizedException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogProductManagementV1UnassignProductsPost(int $id, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogIdUnassignProductsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogProductManagementV1UnassignProductsPost($id, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogCompanyManagementV1AssignCompaniesPost(int $sharedCatalogId, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogSharedCatalogIdAssignCompaniesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogCompanyManagementV1AssignCompaniesPost($sharedCatalogId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $sharedCatalogId
     * @param null|\Kiboko\Magento\V2_3\Model\V1SharedCatalogSharedCatalogIdUnassignCompaniesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function sharedCatalogCompanyManagementV1UnassignCompaniesPost(int $sharedCatalogId, ?\Kiboko\Magento\V2_3\Model\V1SharedCatalogSharedCatalogIdUnassignCompaniesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SharedCatalogCompanyManagementV1UnassignCompaniesPost($sharedCatalogId, $requestBody), $fetch);
    }
    /**
     * Performs persist operations for a specified shipment.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ShipmentPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesShipmentRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ShipmentPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesShipmentRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Performs persist operations for a specified shipment track.
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1ShipmentTrackPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesShipmentTrackRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1ShipmentTrackPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesShipmentTrackRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $id
     * @param null|\Kiboko\Magento\V2_3\Model\V1ShipmentIdCommentsPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function salesShipmentCommentRepositoryV1SavePost(string $id, ?\Kiboko\Magento\V2_3\Model\V1ShipmentIdCommentsPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\SalesShipmentCommentRepositoryV1SavePost($id, $requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function taxTaxClassRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1TaxClassesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxClassRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     ...
     * @param null|\Kiboko\Magento\V2_3\Model\V1TaxClassesClassIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function taxTaxClassRepositoryV1SavePut(string $classId, ?\Kiboko\Magento\V2_3\Model\V1TaxClassesClassIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxClassRepositoryV1SavePut($classId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1TaxRatesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function taxTaxRateRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1TaxRatesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxRateRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Create or update tax rate
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1TaxRatesPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\TaxDataTaxRateInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function taxTaxRateRepositoryV1SavePut(?\Kiboko\Magento\V2_3\Model\V1TaxRatesPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxRateRepositoryV1SavePut($requestBody), $fetch);
    }
    /**
     ...
     * Save TaxRule
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1TaxRulesPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function taxTaxRuleRepositoryV1SavePost(?\Kiboko\Magento\V2_3\Model\V1TaxRulesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxRuleRepositoryV1SavePost($requestBody), $fetch);
    }
    /**
     * Save TaxRule
     *
     * @param null|\Kiboko\Magento\V2_3\Model\V1TaxRulesPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\TaxDataTaxRuleInterface|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function taxTaxRuleRepositoryV1SavePut(?\Kiboko\Magento\V2_3\Model\V1TaxRulesPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TaxTaxRuleRepositoryV1SavePut($requestBody), $fetch);
    }
    /**
     ...
     *
     * @param int $companyId
     * @param null|\Kiboko\Magento\V2_3\Model\V1TeamCompanyIdPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyTeamRepositoryV1CreatePost(int $companyId, ?\Kiboko\Magento\V2_3\Model\V1TeamCompanyIdPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyTeamRepositoryV1CreatePost($companyId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $teamId
     * @param null|\Kiboko\Magento\V2_3\Model\V1TeamTeamIdPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function companyTeamRepositoryV1SavePut(string $teamId, ?\Kiboko\Magento\V2_3\Model\V1TeamTeamIdPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\CompanyTeamRepositoryV1SavePut($teamId, $requestBody), $fetch);
    }
    /**
     * Assign platform shipment IDs to a core RMA entity.
     *
     * @param int $rmaId
     * @param null|\Kiboko\Magento\V2_3\Model\V1TemandoRmaRmaIdShipmentsPutBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPutUnauthorizedException
     * @throws \Kiboko\Magento\V2_3\Exception\TemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPutInternalServerErrorException
     *
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function temandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPut(int $rmaId, ?\Kiboko\Magento\V2_3\Model\V1TemandoRmaRmaIdShipmentsPutBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\TemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPut($rmaId, $requestBody), $fetch);
    }
    /**
     ...
     *
     * @param string $cartId
     * @param null|\Kiboko\Magento\V2_3\Model\V1WorldpayGuestCartsCartIdPaymentInformationPostBody $requestBody
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     * @return null|\Kiboko\Magento\V2_3\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function worldpayGuestPaymentInformationManagementProxyV1SavePaymentInformationAndPlaceOrderPost(string $cartId, ?\Kiboko\Magento\V2_3\Model\V1WorldpayGuestCartsCartIdPaymentInformationPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\V2_3\Endpoint\WorldpayGuestPaymentInformationManagementProxyV1SavePaymentInformationAndPlaceOrderPost($cartId, $requestBody), $fetch);
    }
