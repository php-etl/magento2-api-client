...
class CatalogTierPriceStorageV1UpdatePost extends \Kiboko\Magento\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\Runtime\Client\Endpoint
{
    /**
     ...
     */
    public function __construct(\Kiboko\Magento\Model\V1ProductsTierPricesPostBody $catalogTierPriceStorageV1UpdatePostBody)
    {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Kiboko\Magento\Exception\CatalogTierPriceStorageV1UpdatePostUnauthorizedException($serializer->deserialize($body, 'Kiboko\\Magento\\Model\\ErrorResponse', 'json'), $response);
        }
