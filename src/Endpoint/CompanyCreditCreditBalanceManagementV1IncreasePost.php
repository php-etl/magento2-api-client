...
class CompanyCreditCreditBalanceManagementV1IncreasePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $creditId, ?\Kiboko\Magento\V2\Model\V1CompanyCreditsCreditIdIncreaseBalancePostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1CompanyCreditsCreditIdIncreaseBalancePostBody) {
