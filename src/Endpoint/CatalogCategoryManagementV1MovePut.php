...
class CatalogCategoryManagementV1MovePut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $categoryId, ?\Kiboko\Magento\V2\Model\V1CategoriesCategoryIdMovePutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1CategoriesCategoryIdMovePutBody) {
