...
class SharedCatalogCompanyManagementV1AssignCompaniesPost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $sharedCatalogId, ?\Kiboko\Magento\V2\Model\V1SharedCatalogSharedCatalogIdAssignCompaniesPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1SharedCatalogSharedCatalogIdAssignCompaniesPostBody) {
