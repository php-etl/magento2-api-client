...
class CatalogSpecialPriceStorageV1DeletePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2\Model\V1ProductsSpecialPriceDeletePostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1ProductsSpecialPriceDeletePostBody) {
