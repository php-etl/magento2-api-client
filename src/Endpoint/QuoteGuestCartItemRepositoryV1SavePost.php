...
class QuoteGuestCartItemRepositoryV1SavePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, ?\Kiboko\Magento\V2\Model\V1GuestCartsCartIdItemsPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1GuestCartsCartIdItemsPostBody) {
