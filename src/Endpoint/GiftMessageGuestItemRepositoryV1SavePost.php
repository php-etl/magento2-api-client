...
class GiftMessageGuestItemRepositoryV1SavePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, int $itemId, ?\Kiboko\Magento\V2\Model\V1GuestCartsCartIdGiftMessageItemIdPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
        $this->itemId = $itemId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1GuestCartsCartIdGiftMessageItemIdPostBody) {
