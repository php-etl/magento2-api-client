...
class SalesRuleRuleRepositoryV1SavePut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $ruleId, ?\Kiboko\Magento\V2\Model\V1SalesRulesRuleIdPutBody $requestBody = null)
    {
        $this->ruleId = $ruleId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1SalesRulesRuleIdPutBody) {
