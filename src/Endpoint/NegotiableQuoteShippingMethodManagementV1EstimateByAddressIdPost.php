...
class NegotiableQuoteShippingMethodManagementV1EstimateByAddressIdPost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, ?\Kiboko\Magento\V2\Model\V1NegotiableCartsCartIdEstimateShippingMethodsByAddressIdPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1NegotiableCartsCartIdEstimateShippingMethodsByAddressIdPostBody) {
