...
class SharedCatalogCategoryManagementV1UnassignCategoriesPost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $id, ?\Kiboko\Magento\V2\Model\V1SharedCatalogIdUnassignCategoriesPostBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1SharedCatalogIdUnassignCategoriesPostBody) {
