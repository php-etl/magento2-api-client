...
class PutV1GuestcartsCartIdCollecttotals extends \Kiboko\Magento\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\Runtime\Client\Endpoint
{
    protected $cartId;
    /**
     ...
     */
    public function __construct(string $cartId, \Kiboko\Magento\Model\V1GuestCartsCartIdCollectTotalsPutBody $putV1GuestcartsCartIdCollecttotalsBody)
    {
        $this->cartId = $cartId;
        $this->body = $putV1GuestcartsCartIdCollecttotalsBody;
    }
