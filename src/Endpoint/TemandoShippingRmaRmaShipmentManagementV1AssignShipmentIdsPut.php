...
class TemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $rmaId, ?\Kiboko\Magento\V2\Model\V1TemandoRmaRmaIdShipmentsPutBody $requestBody = null)
    {
        $this->rmaId = $rmaId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1TemandoRmaRmaIdShipmentsPutBody) {
