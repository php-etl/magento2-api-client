...
class GiftMessageItemRepositoryV1SavePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, int $itemId, \Kiboko\Magento\V2\Model\V1CartsCartIdGiftMessageItemIdPostBody $giftMessageItemRepositoryV1SavePostBody)
    {
        $this->cartId = $cartId;
        $this->itemId = $itemId;
