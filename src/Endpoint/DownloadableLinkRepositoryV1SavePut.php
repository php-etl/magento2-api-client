...
class DownloadableLinkRepositoryV1SavePut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $id, ?\Kiboko\Magento\V2\Model\V1ProductsSkuDownloadableLinksIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1ProductsSkuDownloadableLinksIdPutBody) {
