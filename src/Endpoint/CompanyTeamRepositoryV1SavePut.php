...
class CompanyTeamRepositoryV1SavePut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $teamId, ?\Kiboko\Magento\V2\Model\V1TeamTeamIdPutBody $requestBody = null)
    {
        $this->teamId = $teamId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1TeamTeamIdPutBody) {
