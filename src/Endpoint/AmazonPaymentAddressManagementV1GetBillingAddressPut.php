...
class AmazonPaymentAddressManagementV1GetBillingAddressPut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $amazonOrderReferenceId, ?\Kiboko\Magento\V2\Model\V1AmazonBillingAddressAmazonOrderReferenceIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1AmazonBillingAddressAmazonOrderReferenceIdPutBody) {
