...
class CompanyTeamRepositoryV1CreatePost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $companyId, ?\Kiboko\Magento\V2\Model\V1TeamCompanyIdPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1TeamCompanyIdPostBody) {
