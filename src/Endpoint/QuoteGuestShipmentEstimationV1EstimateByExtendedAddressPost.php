...
class QuoteGuestShipmentEstimationV1EstimateByExtendedAddressPost extends \Kiboko\Magento\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\Runtime\Client\Endpoint
{
    protected $cartId;
    /**
     ...
     */
    public function __construct(string $cartId, \Kiboko\Magento\Model\V1GuestCartsCartIdEstimateShippingMethodsPostBody $quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostBody)
    {
        $this->cartId = $cartId;
