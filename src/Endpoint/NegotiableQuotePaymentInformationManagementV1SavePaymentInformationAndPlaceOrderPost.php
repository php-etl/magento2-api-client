...
class NegotiableQuotePaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, ?\Kiboko\Magento\V2\Model\V1NegotiableCartsCartIdPaymentInformationPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1NegotiableCartsCartIdPaymentInformationPostBody) {
