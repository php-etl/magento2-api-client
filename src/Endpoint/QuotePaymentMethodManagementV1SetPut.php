...
class QuotePaymentMethodManagementV1SetPut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2\Model\V1CartsMineSelectedPaymentMethodPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1CartsMineSelectedPaymentMethodPutBody) {
