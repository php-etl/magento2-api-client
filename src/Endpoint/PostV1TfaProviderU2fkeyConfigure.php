...
class PostV1TfaProviderU2fkeyConfigure extends \Kiboko\Magento\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\Runtime\Client\Endpoint
{
    /**
     ...
     */
    public function __construct(\Kiboko\Magento\Model\V1TfaProviderU2fkeyConfigurePostBody $postV1TfaProviderU2fkeyConfigureBody)
    {
        $this->body = $postV1TfaProviderU2fkeyConfigureBody;
    }
    ...
    {
        return '/V1/tfa/provider/u2fkey/configure';
    }
