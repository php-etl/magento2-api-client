...
class CatalogProductAttributeRepositoryV1SavePut extends \Kiboko\Magento\V2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeCode, ?\Kiboko\Magento\V2\Model\V1ProductsAttributesAttributeCodePutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2\Model\V1ProductsAttributesAttributeCodePutBody) {
