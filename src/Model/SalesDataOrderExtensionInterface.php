...
class SalesDataOrderExtensionInterface
{
     ...
     * 
     *
     * @var AmazonPaymentDataOrderLinkInterface|null
     */
     ...
     * 
     *
     * @return AmazonPaymentDataOrderLinkInterface|null
     */
    public function getAmazonOrderReferenceId() : ?AmazonPaymentDataOrderLinkInterface
    {
     ...
     * 
     *
     * @param AmazonPaymentDataOrderLinkInterface|null $amazonOrderReferenceId
     *
     * @return self
     */
    public function setAmazonOrderReferenceId(?AmazonPaymentDataOrderLinkInterface $amazonOrderReferenceId) : self
    {
