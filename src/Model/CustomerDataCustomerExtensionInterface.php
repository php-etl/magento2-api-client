...
class CustomerDataCustomerExtensionInterface
{
     ...
     * @var string|null
     */
    protected $vertexCustomerCountry;
    /**
     * 
     *
     * @return bool|null
     ...
     * @return string|null
     */
    public function getVertexCustomerCountry() : ?string
    {
        return $this->vertexCustomerCountry;
    }
    /**
     * 
     *
     * @param string|null $vertexCustomerCountry
     *
     * @return self
     */
    public function setVertexCustomerCountry(?string $vertexCustomerCountry) : self
    {
        $this->initialized['vertexCustomerCountry'] = true;
        $this->vertexCustomerCountry = $vertexCustomerCountry;
        return $this;
    }
}