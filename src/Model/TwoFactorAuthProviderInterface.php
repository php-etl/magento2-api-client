...
class TwoFactorAuthProviderInterface
{
    /**
     * @var array
     */
     ...
     *
     * @var TwoFactorAuthEngineInterface|null
     */
    protected $engine;
    /**
     * Provider code
     ...
     * 2FA engine interface
     *
     * @return TwoFactorAuthEngineInterface|null
     */
    public function getEngine() : ?TwoFactorAuthEngineInterface
    {
        return $this->engine;
    }
    /**
     * 2FA engine interface
     *
     * @param TwoFactorAuthEngineInterface|null $engine
     *
     * @return self
     */
    public function setEngine(?TwoFactorAuthEngineInterface $engine) : self
    {
