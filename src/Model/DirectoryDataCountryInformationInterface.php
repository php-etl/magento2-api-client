...
class DirectoryDataCountryInformationInterface
{
    ...
    {
        $this->initialized['twoLetterAbbreviation'] = true;
    ...
    {
        $this->initialized['threeLetterAbbreviation'] = true;
    ...
    {
        $this->initialized['fullNameLocale'] = true;
    ...
    {
        $this->initialized['fullNameEnglish'] = true;
