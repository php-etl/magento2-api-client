...
class SalesShipmentTrackRepositoryV1SavePost extends \Kiboko\Magento\V2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2_4\Model\V1ShipmentTrackPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_4\Model\V1ShipmentTrackPostBody) {
