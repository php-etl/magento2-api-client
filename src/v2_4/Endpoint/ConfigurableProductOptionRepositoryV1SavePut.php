...
class ConfigurableProductOptionRepositoryV1SavePut extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $id, ?\Kiboko\Magento\v2_4\Model\V1ConfigurableProductsSkuOptionsIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1ConfigurableProductsSkuOptionsIdPutBody) {
