...
class CompanyCompanyHierarchyV1MoveNodePut extends \Kiboko\Magento\V2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $id, ?\Kiboko\Magento\V2_4\Model\V1HierarchyMoveIdPutBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_4\Model\V1HierarchyMoveIdPutBody) {
