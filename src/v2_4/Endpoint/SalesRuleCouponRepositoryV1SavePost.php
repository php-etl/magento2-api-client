...
class SalesRuleCouponRepositoryV1SavePost extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\v2_4\Model\V1CouponsPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1CouponsPostBody) {
