...
class GiftMessageItemRepositoryV1SavePost extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, int $itemId, \Kiboko\Magento\v2_4\Model\V1CartsCartIdGiftMessageItemIdPostBody $giftMessageItemRepositoryV1SavePostBody)
    {
        $this->cartId = $cartId;
        $this->itemId = $itemId;
