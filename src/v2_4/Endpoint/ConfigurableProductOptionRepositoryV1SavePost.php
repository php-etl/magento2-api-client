...
class ConfigurableProductOptionRepositoryV1SavePost extends \Kiboko\Magento\V2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, ?\Kiboko\Magento\V2_4\Model\V1ConfigurableProductsSkuOptionsPostBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_4\Model\V1ConfigurableProductsSkuOptionsPostBody) {
