...
class EavAttributeSetRepositoryV1SavePut extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeSetId, ?\Kiboko\Magento\v2_4\Model\V1EavAttributeSetsAttributeSetIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1EavAttributeSetsAttributeSetIdPutBody) {
