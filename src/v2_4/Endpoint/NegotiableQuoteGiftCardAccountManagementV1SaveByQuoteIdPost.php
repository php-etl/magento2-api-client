...
class NegotiableQuoteGiftCardAccountManagementV1SaveByQuoteIdPost extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, ?\Kiboko\Magento\v2_4\Model\V1NegotiableCartsCartIdGiftCardsPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1NegotiableCartsCartIdGiftCardsPostBody) {
