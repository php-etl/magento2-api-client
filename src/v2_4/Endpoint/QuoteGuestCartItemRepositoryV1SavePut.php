...
class QuoteGuestCartItemRepositoryV1SavePut extends \Kiboko\Magento\V2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, string $itemId, ?\Kiboko\Magento\V2_4\Model\V1GuestCartsCartIdItemsItemIdPutBody $requestBody = null)
    {
        $this->cartId = $cartId;
        $this->itemId = $itemId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_4\Model\V1GuestCartsCartIdItemsItemIdPutBody) {
