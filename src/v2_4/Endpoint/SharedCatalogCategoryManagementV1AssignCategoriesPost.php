...
class SharedCatalogCategoryManagementV1AssignCategoriesPost extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
    ...
    {
        return '/V1/sharedCatalog/{id}/assignCategories';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Kiboko\Magento\v2_4\Exception\SharedCatalogCategoryManagementV1AssignCategoriesPostBadRequestException();
        }
        if (401 === $status) {
            throw new \Kiboko\Magento\v2_4\Exception\SharedCatalogCategoryManagementV1AssignCategoriesPostUnauthorizedException();
        }
        return null;
    }
