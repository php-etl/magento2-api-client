...
class SharedCatalogCompanyManagementV1UnassignCompaniesPost extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $sharedCatalogId, ?\Kiboko\Magento\v2_4\Model\V1SharedCatalogSharedCatalogIdUnassignCompaniesPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1SharedCatalogSharedCatalogIdUnassignCompaniesPostBody) {
