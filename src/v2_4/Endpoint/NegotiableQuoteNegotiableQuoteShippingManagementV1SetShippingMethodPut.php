...
class NegotiableQuoteNegotiableQuoteShippingManagementV1SetShippingMethodPut extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $quoteId, ?\Kiboko\Magento\v2_4\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody) {
