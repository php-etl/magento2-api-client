...
class CatalogProductWebsiteLinkRepositoryV1SavePut extends \Kiboko\Magento\v2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, ?\Kiboko\Magento\v2_4\Model\V1ProductsSkuWebsitesPutBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_4\Model\V1ProductsSkuWebsitesPutBody) {
