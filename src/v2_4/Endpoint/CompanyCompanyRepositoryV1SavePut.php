...
class CompanyCompanyRepositoryV1SavePut extends \Kiboko\Magento\V2_4\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_4\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $companyId, ?\Kiboko\Magento\V2_4\Model\V1CompanyCompanyIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_4\Model\V1CompanyCompanyIdPutBody) {
