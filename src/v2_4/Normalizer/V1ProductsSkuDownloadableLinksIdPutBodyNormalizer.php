...
class V1ProductsSkuDownloadableLinksIdPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_4\\Model\\V1ProductsSkuDownloadableLinksIdPutBody';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_4\\Model\\V1ProductsSkuDownloadableLinksIdPutBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_4\Model\V1ProductsSkuDownloadableLinksIdPutBody();
        ...
        if (\array_key_exists('link', $data)) {
            $object->setLink($this->denormalizer->denormalize($data['link'], 'Kiboko\\Magento\\v2_4\\Model\\DownloadableDataLinkInterface', 'json', $context));
        }
        return $object;
    }
    /**
