...
class CatalogDataProductOptionExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataProductOptionExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataProductOptionExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_4\Model\CatalogDataProductOptionExtensionInterface();
        ...
        if (\array_key_exists('custom_options', $data)) {
            ...
            foreach ($data['custom_options'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataCustomOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('bundle_options', $data)) {
            ...
            foreach ($data['bundle_options'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_4\\Model\\BundleDataBundleOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('configurable_item_options', $data)) {
            ...
            foreach ($data['configurable_item_options'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_4\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface', 'json', $context);
            }
