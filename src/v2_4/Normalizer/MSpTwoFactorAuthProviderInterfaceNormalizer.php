...
class MSpTwoFactorAuthProviderInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_4\\Model\\MSpTwoFactorAuthProviderInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_4\\Model\\MSpTwoFactorAuthProviderInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_4\Model\MSpTwoFactorAuthProviderInterface();
        ...
        if (\array_key_exists('engine', $data)) {
            $object->setEngine($this->denormalizer->denormalize($data['engine'], 'Kiboko\\Magento\\v2_4\\Model\\MSpTwoFactorAuthEngineInterface', 'json', $context));
        }
