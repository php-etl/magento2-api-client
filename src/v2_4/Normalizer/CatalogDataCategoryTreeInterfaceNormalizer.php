...
class CatalogDataCategoryTreeInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataCategoryTreeInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataCategoryTreeInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_4\Model\CatalogDataCategoryTreeInterface();
        ...
        if (\array_key_exists('children_data', $data)) {
            ...
            foreach ($data['children_data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_4\\Model\\CatalogDataCategoryTreeInterface', 'json', $context);
            }
