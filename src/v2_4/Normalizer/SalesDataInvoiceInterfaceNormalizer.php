    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_4\\Model\\SalesDataInvoiceItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('comments', $data)) {
            ...
            foreach ($data['comments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_4\\Model\\SalesDataInvoiceCommentInterface', 'json', $context);
            }
