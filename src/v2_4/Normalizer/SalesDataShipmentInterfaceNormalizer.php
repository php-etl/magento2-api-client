    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('packages', $data)) {
            ...
            foreach ($data['packages'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_4\\Model\\SalesDataShipmentPackageInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tracks', $data)) {
            ...
            foreach ($data['tracks'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_4\\Model\\SalesDataShipmentTrackInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('comments', $data)) {
            ...
            foreach ($data['comments'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\v2_4\\Model\\SalesDataShipmentCommentInterface', 'json', $context);
            }
