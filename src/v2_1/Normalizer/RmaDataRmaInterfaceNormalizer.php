    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_1\\Model\\RmaDataItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('comments', $data)) {
            ...
            foreach ($data['comments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_1\\Model\\RmaDataCommentInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tracks', $data)) {
            ...
            foreach ($data['tracks'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_1\\Model\\RmaDataTrackInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('custom_attributes', $data)) {
            ...
            foreach ($data['custom_attributes'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\v2_1\\Model\\FrameworkAttributeInterface', 'json', $context);
            }
