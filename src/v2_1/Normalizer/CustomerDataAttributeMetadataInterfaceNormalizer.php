    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('validation_rules', $data)) {
            ...
            foreach ($data['validation_rules'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_1\\Model\\CustomerDataValidationRuleInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data)) {
            ...
            foreach ($data['options'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_1\\Model\\CustomerDataOptionInterface', 'json', $context);
            }
