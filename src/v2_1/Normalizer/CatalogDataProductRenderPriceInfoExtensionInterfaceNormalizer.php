...
class CatalogDataProductRenderPriceInfoExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_1\\Model\\CatalogDataProductRenderPriceInfoExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_1\\Model\\CatalogDataProductRenderPriceInfoExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_1\Model\CatalogDataProductRenderPriceInfoExtensionInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('msrp', $data)) {
            $object->setMsrp($this->denormalizer->denormalize($data['msrp'], 'Kiboko\\Magento\\v2_1\\Model\\MsrpDataProductRenderMsrpPriceInfoInterface', 'json', $context));
        }
        if (\array_key_exists('tax_adjustments', $data)) {
            $object->setTaxAdjustments($this->denormalizer->denormalize($data['tax_adjustments'], 'Kiboko\\Magento\\v2_1\\Model\\CatalogDataProductRenderPriceInfoInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('weee_attributes', $data)) {
            ...
            foreach ($data['weee_attributes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_1\\Model\\WeeeDataProductRenderWeeeAdjustmentAttributeInterface', 'json', $context);
            }
