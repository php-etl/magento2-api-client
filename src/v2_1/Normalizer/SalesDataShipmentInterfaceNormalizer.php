...
class SalesDataShipmentInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_1\Model\SalesDataShipmentInterface();
        ...
        if (\array_key_exists('comments', $data) && $data['comments'] !== null) {
            ...
            foreach ($data['comments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentCommentInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentExtensionInterface', 'json', $context));
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('packages', $data) && $data['packages'] !== null) {
            ...
            foreach ($data['packages'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentPackageInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tracks', $data) && $data['tracks'] !== null) {
            ...
            foreach ($data['tracks'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2_1\\Model\\SalesDataShipmentTrackInterface', 'json', $context);
            }
