...
class AsynchronousOperationsDataBulkOperationsStatusInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataBulkOperationsStatusInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataBulkOperationsStatusInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_1\Model\AsynchronousOperationsDataBulkOperationsStatusInterface();
        ...
        if (\array_key_exists('operations_list', $data)) {
            ...
            foreach ($data['operations_list'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataSummaryOperationStatusInterface', 'json', $context);
            }
