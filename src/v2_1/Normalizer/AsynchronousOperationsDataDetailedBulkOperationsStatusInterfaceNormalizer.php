...
class AsynchronousOperationsDataDetailedBulkOperationsStatusInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataDetailedBulkOperationsStatusInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataDetailedBulkOperationsStatusInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_1\Model\AsynchronousOperationsDataDetailedBulkOperationsStatusInterface();
        ...
        if (\array_key_exists('operations_list', $data) && $data['operations_list'] !== null) {
            ...
            foreach ($data['operations_list'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_1\\Model\\AsynchronousOperationsDataDetailedOperationStatusInterface', 'json', $context);
            }
