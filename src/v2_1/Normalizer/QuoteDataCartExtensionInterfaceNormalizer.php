...
class QuoteDataCartExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_1\\Model\\QuoteDataCartExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_1\\Model\\QuoteDataCartExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_1\Model\QuoteDataCartExtensionInterface();
        ...
        if (\array_key_exists('negotiable_quote', $data)) {
            $object->setNegotiableQuote($this->denormalizer->denormalize($data['negotiable_quote'], 'Kiboko\\Magento\\V2_1\\Model\\NegotiableQuoteDataNegotiableQuoteInterface', 'json', $context));
        }
        if (\array_key_exists('shipping_assignments', $data)) {
            $values = array();
            foreach ($data['shipping_assignments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_1\\Model\\QuoteDataShippingAssignmentInterface', 'json', $context);
            }
