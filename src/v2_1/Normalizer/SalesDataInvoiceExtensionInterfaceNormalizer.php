...
class SalesDataInvoiceExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('vertex_tax_calculation_billing_address', $data)) {
            $object->setVertexTaxCalculationBillingAddress($this->denormalizer->denormalize($data['vertex_tax_calculation_billing_address'], 'Kiboko\\Magento\\v2_1\\Model\\SalesDataOrderAddressInterface', 'json', $context));
        }
        if (\array_key_exists('vertex_tax_calculation_order', $data)) {
            $object->setVertexTaxCalculationOrder($this->denormalizer->denormalize($data['vertex_tax_calculation_order'], 'Kiboko\\Magento\\v2_1\\Model\\SalesDataOrderInterface', 'json', $context));
        }
        if (\array_key_exists('vertex_tax_calculation_shipping_address', $data)) {
            $object->setVertexTaxCalculationShippingAddress($this->denormalizer->denormalize($data['vertex_tax_calculation_shipping_address'], 'Kiboko\\Magento\\v2_1\\Model\\SalesDataOrderAddressInterface', 'json', $context));
        }
        return $object;
    }
    /**
