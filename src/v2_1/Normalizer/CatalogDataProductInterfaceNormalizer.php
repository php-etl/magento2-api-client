    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('media_gallery_entries', $data) && $data['media_gallery_entries'] !== null) {
            ...
            foreach ($data['media_gallery_entries'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2_1\\Model\\CatalogDataProductAttributeMediaGalleryEntryInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data) && $data['options'] !== null) {
            ...
            foreach ($data['options'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2_1\\Model\\CatalogDataProductCustomOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('product_links', $data) && $data['product_links'] !== null) {
            ...
            foreach ($data['product_links'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2_1\\Model\\CatalogDataProductLinkInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tier_prices', $data) && $data['tier_prices'] !== null) {
            ...
            foreach ($data['tier_prices'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Kiboko\\Magento\\V2_1\\Model\\CatalogDataProductTierPriceInterface', 'json', $context);
            }
