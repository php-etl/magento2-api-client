...
class V1NegotiableQuoteSubmitToCustomerPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_1\\Model\\V1NegotiableQuoteSubmitToCustomerPostBody';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_1\\Model\\V1NegotiableQuoteSubmitToCustomerPostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_1\Model\V1NegotiableQuoteSubmitToCustomerPostBody();
        ...
        if (\array_key_exists('files', $data) && $data['files'] !== null) {
            ...
            foreach ($data['files'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_1\\Model\\NegotiableQuoteDataAttachmentContentInterface', 'json', $context);
            }
