...
class DownloadableSampleRepositoryV1SavePut extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $id, ?\Kiboko\Magento\v2_1\Model\V1ProductsSkuDownloadableLinksSamplesIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1ProductsSkuDownloadableLinksSamplesIdPutBody) {
