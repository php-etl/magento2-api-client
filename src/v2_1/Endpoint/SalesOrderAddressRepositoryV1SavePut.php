...
class SalesOrderAddressRepositoryV1SavePut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $parentId, ?\Kiboko\Magento\V2_1\Model\V1OrdersParentIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1OrdersParentIdPutBody) {
