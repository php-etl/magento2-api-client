...
class CheckoutShippingInformationManagementV1SaveAddressInformationPost extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\v2_1\Model\V1CartsMineShippingInformationPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1CartsMineShippingInformationPostBody) {
