...
class RmaCommentManagementV1AddCommentPost extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Kiboko\Magento\v2_1\Model\V1ReturnsIdCommentsPostBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1ReturnsIdCommentsPostBody) {
