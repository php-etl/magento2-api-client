...
class CatalogProductAttributeOptionManagementV1AddPost extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeCode, ?\Kiboko\Magento\v2_1\Model\V1ProductsAttributesAttributeCodeOptionsPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1ProductsAttributesAttributeCodeOptionsPostBody) {
