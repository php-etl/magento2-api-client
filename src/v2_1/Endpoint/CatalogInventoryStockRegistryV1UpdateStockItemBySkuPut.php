...
class CatalogInventoryStockRegistryV1UpdateStockItemBySkuPut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $productSku, string $itemId, ?\Kiboko\Magento\V2_1\Model\V1ProductsProductSkuStockItemsItemIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1ProductsProductSkuStockItemsItemIdPutBody) {
