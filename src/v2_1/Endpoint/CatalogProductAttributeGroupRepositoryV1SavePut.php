...
class CatalogProductAttributeGroupRepositoryV1SavePut extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $attributeSetId, ?\Kiboko\Magento\v2_1\Model\V1ProductsAttributeSetsAttributeSetIdGroupsPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1ProductsAttributeSetsAttributeSetIdGroupsPutBody) {
