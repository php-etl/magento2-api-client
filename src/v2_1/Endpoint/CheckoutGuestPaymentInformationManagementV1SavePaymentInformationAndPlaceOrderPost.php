...
class CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPost extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, ?\Kiboko\Magento\V2_1\Model\V1GuestCartsCartIdPaymentInformationPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1GuestCartsCartIdPaymentInformationPostBody) {
