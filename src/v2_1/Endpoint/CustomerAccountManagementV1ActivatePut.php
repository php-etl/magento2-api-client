...
class CustomerAccountManagementV1ActivatePut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $email, ?\Kiboko\Magento\V2_1\Model\V1CustomersEmailActivatePutBody $requestBody = null)
    {
        $this->email = $email;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1CustomersEmailActivatePutBody) {
