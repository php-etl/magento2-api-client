...
class GiftWrappingWrappingRepositoryV1SavePut extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $wrappingId, ?\Kiboko\Magento\v2_1\Model\V1GiftWrappingsWrappingIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1GiftWrappingsWrappingIdPutBody) {
