...
class SalesRuleRuleRepositoryV1SavePut extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $ruleId, ?\Kiboko\Magento\v2_1\Model\V1SalesRulesRuleIdPutBody $requestBody = null)
    {
        $this->ruleId = $ruleId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1SalesRulesRuleIdPutBody) {
