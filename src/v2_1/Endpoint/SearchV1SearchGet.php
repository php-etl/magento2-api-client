...
class SearchV1SearchGet extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('searchCriteria[requestName]', 'searchCriteria[filterGroups][][filters][][field]', 'searchCriteria[filterGroups][][filters][][value]', 'searchCriteria[filterGroups][][filters][][conditionType]', 'searchCriteria[sortOrders][][field]', 'searchCriteria[sortOrders][][direction]', 'searchCriteria[pageSize]', 'searchCriteria[currentPage]'));
     ...
     *
     *
     * @return null|\Kiboko\Magento\v2_1\Model\FrameworkSearchSearchResultInterface|\Kiboko\Magento\v2_1\Model\ErrorResponse
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Kiboko\\Magento\\v2_1\\Model\\FrameworkSearchSearchResultInterface', 'json');
        }
