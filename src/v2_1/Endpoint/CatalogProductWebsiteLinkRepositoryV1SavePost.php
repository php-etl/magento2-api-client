...
class CatalogProductWebsiteLinkRepositoryV1SavePost extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, ?\Kiboko\Magento\V2_1\Model\V1ProductsSkuWebsitesPostBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1ProductsSkuWebsitesPostBody) {
