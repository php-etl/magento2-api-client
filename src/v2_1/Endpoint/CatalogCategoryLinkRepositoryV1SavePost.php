...
class CatalogCategoryLinkRepositoryV1SavePost extends \Kiboko\Magento\v2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $categoryId, ?\Kiboko\Magento\v2_1\Model\V1CategoriesCategoryIdProductsPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_1\Model\V1CategoriesCategoryIdProductsPostBody) {
