...
class CatalogCategoryRepositoryV1SavePut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Kiboko\Magento\V2_1\Model\V1CategoriesIdPutBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1CategoriesIdPutBody) {
