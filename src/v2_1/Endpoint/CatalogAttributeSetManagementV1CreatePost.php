...
class CatalogAttributeSetManagementV1CreatePost extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2_1\Model\V1ProductsAttributeSetsPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1ProductsAttributeSetsPostBody) {
