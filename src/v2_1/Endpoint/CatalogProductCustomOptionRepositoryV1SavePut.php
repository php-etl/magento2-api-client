...
class CatalogProductCustomOptionRepositoryV1SavePut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $optionId, ?\Kiboko\Magento\V2_1\Model\V1ProductsOptionsOptionIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1ProductsOptionsOptionIdPutBody) {
