...
class CatalogProductAttributeMediaGalleryManagementV1UpdatePut extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $entryId, ?\Kiboko\Magento\V2_1\Model\V1ProductsSkuMediaEntryIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1ProductsSkuMediaEntryIdPutBody) {
