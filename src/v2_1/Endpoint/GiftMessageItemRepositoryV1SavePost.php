...
class GiftMessageItemRepositoryV1SavePost extends \Kiboko\Magento\V2_1\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_1\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $itemId, ?\Kiboko\Magento\V2_1\Model\V1CartsMineGiftMessageItemIdPostBody $requestBody = null)
    {
        $this->itemId = $itemId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_1\Model\V1CartsMineGiftMessageItemIdPostBody) {
