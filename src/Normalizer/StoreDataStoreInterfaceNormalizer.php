...
class StoreDataStoreInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\StoreDataStoreInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\StoreDataStoreInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\StoreDataStoreInterface();
        ...
        if (\array_key_exists('store_group_id', $data) && $data['store_group_id'] !== null) {
            $object->setStoreGroupId($data['store_group_id']);
        }
        elseif (\array_key_exists('store_group_id', $data) && $data['store_group_id'] === null) {
            $object->setStoreGroupId(null);
        }
    ...
    {
        return array('Kiboko\\Magento\\Model\\StoreDataStoreInterface' => false);
    }
}