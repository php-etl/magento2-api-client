...
class CatalogDataProductOptionExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\CatalogDataProductOptionExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\CatalogDataProductOptionExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\CatalogDataProductOptionExtensionInterface();
        ...
        if (\array_key_exists('configurable_item_options', $data) && $data['configurable_item_options'] !== null) {
            ...
            foreach ($data['configurable_item_options'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\Model\\ConfigurableProductDataConfigurableItemOptionValueInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('bundle_options', $data) && $data['bundle_options'] !== null) {
            $values_2 = array();
            foreach ($data['bundle_options'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\Model\\BundleDataBundleOptionInterface', 'json', $context);
            }
            $object->setBundleOptions($values_2);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('bundleOptions') && null !== $object->getBundleOptions()) {
            $values_2 = array();
            foreach ($object->getBundleOptions() as $value_2) {
                $values_2[] = $this->normalizer->normalize($value_2, 'json', $context);
            }
            $data['bundle_options'] = $values_2;
        }
        return $data;
    }
    public function getSupportedTypes(?string $format = null) : array
    {
        return array('Kiboko\\Magento\\Model\\CatalogDataProductOptionExtensionInterface' => false);
    }
}