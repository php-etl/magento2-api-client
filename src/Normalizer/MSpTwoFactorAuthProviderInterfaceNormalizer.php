...
class MSpTwoFactorAuthProviderInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\MSpTwoFactorAuthProviderInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\MSpTwoFactorAuthProviderInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\MSpTwoFactorAuthProviderInterface();
        ...
        if (\array_key_exists('engine', $data) && $data['engine'] !== null) {
            $object->setEngine($this->denormalizer->denormalize($data['engine'], 'Kiboko\\Magento\\Model\\MSpTwoFactorAuthEngineInterface', 'json', $context));
        }
    ...
    {
        return array('Kiboko\\Magento\\Model\\MSpTwoFactorAuthProviderInterface' => false);
    }
}