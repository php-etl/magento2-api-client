...
class SalesDataCreditmemoCreationArgumentsExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataCreditmemoCreationArgumentsExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataCreditmemoCreationArgumentsExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataCreditmemoCreationArgumentsExtensionInterface();
    ...
    {
        $data = array();
        if ($object->isInitialized('returnToStockItems') && null !== $object->getReturnToStockItems()) {
            $values = array();
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataCreditmemoCreationArgumentsExtensionInterface' => false);
    }
}