...
class CustomerDataCustomerExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('vertex_customer_country', $data) && $data['vertex_customer_country'] !== null) {
            $object->setVertexCustomerCountry($data['vertex_customer_country']);
        }
        elseif (\array_key_exists('vertex_customer_country', $data) && $data['vertex_customer_country'] === null) {
            $object->setVertexCustomerCountry(null);
        }
        return $object;
    }
    /**
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('vertexCustomerCountry') && null !== $object->getVertexCustomerCountry()) {
            $data['vertex_customer_country'] = $object->getVertexCustomerCountry();
        }
        return $data;
    }
