...
class SalesDataInvoiceExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataInvoiceExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataInvoiceExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataInvoiceExtensionInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('vertex_tax_calculation_shipping_address', $data) && $data['vertex_tax_calculation_shipping_address'] !== null) {
            $object->setVertexTaxCalculationShippingAddress($this->denormalizer->denormalize($data['vertex_tax_calculation_shipping_address'], 'Kiboko\\Magento\\Model\\SalesDataOrderAddressInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('vertex_tax_calculation_billing_address', $data) && $data['vertex_tax_calculation_billing_address'] !== null) {
            $object->setVertexTaxCalculationBillingAddress($this->denormalizer->denormalize($data['vertex_tax_calculation_billing_address'], 'Kiboko\\Magento\\Model\\SalesDataOrderAddressInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('vertex_tax_calculation_order', $data) && $data['vertex_tax_calculation_order'] !== null) {
            $object->setVertexTaxCalculationOrder($this->denormalizer->denormalize($data['vertex_tax_calculation_order'], 'Kiboko\\Magento\\Model\\SalesDataOrderInterface', 'json', $context));
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('vertexTaxCalculationShippingAddress') && null !== $object->getVertexTaxCalculationShippingAddress()) {
        ...
        if ($object->isInitialized('vertexTaxCalculationBillingAddress') && null !== $object->getVertexTaxCalculationBillingAddress()) {
        ...
        if ($object->isInitialized('vertexTaxCalculationOrder') && null !== $object->getVertexTaxCalculationOrder()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataInvoiceExtensionInterface' => false);
    }
}