...
class CatalogDataProductInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\CatalogDataProductInterface();
        ...
        if (\array_key_exists('extension_attributes', $data)) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductExtensionInterface', 'json', $context));
        }
        if (\array_key_exists('product_links', $data)) {
            $values = array();
            foreach ($data['product_links'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductLinkInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data)) {
            ...
            foreach ($data['options'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductCustomOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('media_gallery_entries', $data)) {
            ...
            foreach ($data['media_gallery_entries'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductAttributeMediaGalleryEntryInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tier_prices', $data)) {
            ...
            foreach ($data['tier_prices'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\V2\\Model\\CatalogDataProductTierPriceInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('custom_attributes', $data)) {
            ...
            foreach ($data['custom_attributes'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Kiboko\\Magento\\V2\\Model\\FrameworkAttributeInterface', 'json', $context);
            }
