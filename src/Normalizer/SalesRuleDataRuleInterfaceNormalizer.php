...
class SalesRuleDataRuleInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataRuleInterface';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataRuleInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\SalesRuleDataRuleInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('action_condition', $data)) {
            $object->setActionCondition($this->denormalizer->denormalize($data['action_condition'], 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataConditionInterface', 'json', $context));
        }
        if (\array_key_exists('apply_to_shipping', $data)) {
            $object->setApplyToShipping($data['apply_to_shipping']);
        }
        if (\array_key_exists('condition', $data)) {
            $object->setCondition($this->denormalizer->denormalize($data['condition'], 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataConditionInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('extension_attributes', $data)) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataRuleExtensionInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('store_labels', $data)) {
            ...
            foreach ($data['store_labels'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\V2\\Model\\SalesRuleDataRuleLabelInterface', 'json', $context);
            }
