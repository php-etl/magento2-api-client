...
class InventorySalesApiDataProductSalableResultInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\InventorySalesApiDataProductSalableResultInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\InventorySalesApiDataProductSalableResultInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\InventorySalesApiDataProductSalableResultInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\InventorySalesApiDataProductSalableResultInterface' => false);
    }
}