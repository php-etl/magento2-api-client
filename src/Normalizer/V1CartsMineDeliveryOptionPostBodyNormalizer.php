...
class V1CartsMineDeliveryOptionPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\V1CartsMineDeliveryOptionPostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\V1CartsMineDeliveryOptionPostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\V1CartsMineDeliveryOptionPostBody();
    ...
    {
        return array('Kiboko\\Magento\\Model\\V1CartsMineDeliveryOptionPostBody' => false);
    }
}