...
class EavDataAttributeGroupInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\EavDataAttributeGroupInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\EavDataAttributeGroupInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\EavDataAttributeGroupInterface();
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\Model\\EavDataAttributeGroupExtensionInterface', 'json', $context));
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('attributeGroupId') && null !== $object->getAttributeGroupId()) {
            $data['attribute_group_id'] = $object->getAttributeGroupId();
        }
        if ($object->isInitialized('attributeGroupName') && null !== $object->getAttributeGroupName()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\EavDataAttributeGroupInterface' => false);
    }
}