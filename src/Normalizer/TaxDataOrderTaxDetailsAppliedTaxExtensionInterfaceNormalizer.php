...
class TaxDataOrderTaxDetailsAppliedTaxExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2\\Model\\TaxDataOrderTaxDetailsAppliedTaxExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2\\Model\\TaxDataOrderTaxDetailsAppliedTaxExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\TaxDataOrderTaxDetailsAppliedTaxExtensionInterface();
        ...
        if (\array_key_exists('rates', $data)) {
            ...
            foreach ($data['rates'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2\\Model\\TaxDataAppliedTaxRateInterface', 'json', $context);
            }
