...
class SalesDataShipmentItemCreationInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataShipmentItemCreationInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataShipmentItemCreationInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataShipmentItemCreationInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataShipmentItemCreationInterface' => false);
    }
}