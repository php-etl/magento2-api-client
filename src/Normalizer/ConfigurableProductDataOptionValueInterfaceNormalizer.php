...
class ConfigurableProductDataOptionValueInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\ConfigurableProductDataOptionValueInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\ConfigurableProductDataOptionValueInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\ConfigurableProductDataOptionValueInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\ConfigurableProductDataOptionValueInterface' => false);
    }
}