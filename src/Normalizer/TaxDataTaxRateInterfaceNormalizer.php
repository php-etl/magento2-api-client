...
class TaxDataTaxRateInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\TaxDataTaxRateInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\TaxDataTaxRateInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\TaxDataTaxRateInterface();
        ...
        if (\array_key_exists('titles', $data) && $data['titles'] !== null) {
            ...
            foreach ($data['titles'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\Model\\TaxDataTaxRateTitleInterface', 'json', $context);
            }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('taxRegionId') && null !== $object->getTaxRegionId()) {
        ...
        if ($object->isInitialized('taxPostcode') && null !== $object->getTaxPostcode()) {
            $data['tax_postcode'] = $object->getTaxPostcode();
        }
        if ($object->isInitialized('zipIsRange') && null !== $object->getZipIsRange()) {
            $data['zip_is_range'] = $object->getZipIsRange();
        }
        if ($object->isInitialized('zipFrom') && null !== $object->getZipFrom()) {
            $data['zip_from'] = $object->getZipFrom();
        }
        if ($object->isInitialized('zipTo') && null !== $object->getZipTo()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\TaxDataTaxRateInterface' => false);
    }
}