...
class SalesDataOrderExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('pickup_location_code', $data) && $data['pickup_location_code'] !== null) {
            $object->setPickupLocationCode($data['pickup_location_code']);
        }
        elseif (\array_key_exists('pickup_location_code', $data) && $data['pickup_location_code'] === null) {
            $object->setPickupLocationCode(null);
        }
        if (\array_key_exists('notification_sent', $data) && $data['notification_sent'] !== null) {
            $object->setNotificationSent($data['notification_sent']);
        }
        elseif (\array_key_exists('notification_sent', $data) && $data['notification_sent'] === null) {
            $object->setNotificationSent(null);
        }
        if (\array_key_exists('send_notification', $data) && $data['send_notification'] !== null) {
            $object->setSendNotification($data['send_notification']);
        }
        elseif (\array_key_exists('send_notification', $data) && $data['send_notification'] === null) {
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('pickupLocationCode') && null !== $object->getPickupLocationCode()) {
            $data['pickup_location_code'] = $object->getPickupLocationCode();
        }
        if ($object->isInitialized('notificationSent') && null !== $object->getNotificationSent()) {
            $data['notification_sent'] = $object->getNotificationSent();
        }
        if ($object->isInitialized('sendNotification') && null !== $object->getSendNotification()) {
            $data['send_notification'] = $object->getSendNotification();
        }
