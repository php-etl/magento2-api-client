...
class FrameworkSearchSearchCriteriaInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2\\Model\\FrameworkSearchSearchCriteriaInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2\\Model\\FrameworkSearchSearchCriteriaInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\FrameworkSearchSearchCriteriaInterface();
        ...
        if (\array_key_exists('filter_groups', $data)) {
            ...
            foreach ($data['filter_groups'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2\\Model\\FrameworkSearchFilterGroup', 'json', $context);
            }
        ...
        if (\array_key_exists('sort_orders', $data)) {
            ...
            foreach ($data['sort_orders'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\V2\\Model\\FrameworkSortOrder', 'json', $context);
            }
