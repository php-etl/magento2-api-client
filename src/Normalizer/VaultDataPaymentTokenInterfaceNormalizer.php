...
class VaultDataPaymentTokenInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\VaultDataPaymentTokenInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\VaultDataPaymentTokenInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\VaultDataPaymentTokenInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\VaultDataPaymentTokenInterface' => false);
    }
}