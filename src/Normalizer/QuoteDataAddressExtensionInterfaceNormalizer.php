...
class QuoteDataAddressExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\QuoteDataAddressExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\QuoteDataAddressExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\QuoteDataAddressExtensionInterface();
        ...
        if (\array_key_exists('discounts', $data) && $data['discounts'] !== null) {
            ...
            foreach ($data['discounts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\Model\\SalesRuleDataRuleDiscountInterface', 'json', $context);
            }
    ...
    {
        return array('Kiboko\\Magento\\Model\\QuoteDataAddressExtensionInterface' => false);
    }
}