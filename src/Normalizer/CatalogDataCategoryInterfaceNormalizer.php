...
class CatalogDataCategoryInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\CatalogDataCategoryInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\CatalogDataCategoryInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\CatalogDataCategoryInterface();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('availableSortBy') && null !== $object->getAvailableSortBy()) {
            $values = array();
        ...
        if ($object->isInitialized('includeInMenu') && null !== $object->getIncludeInMenu()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\CatalogDataCategoryInterface' => false);
    }
}