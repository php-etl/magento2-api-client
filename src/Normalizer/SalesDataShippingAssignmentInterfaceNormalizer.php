...
class SalesDataShippingAssignmentInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataShippingAssignmentInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataShippingAssignmentInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataShippingAssignmentInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('shipping', $data) && $data['shipping'] !== null) {
            $object->setShipping($this->denormalizer->denormalize($data['shipping'], 'Kiboko\\Magento\\Model\\SalesDataShippingInterface', 'json', $context));
        }
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataShippingAssignmentInterface' => false);
    }
}