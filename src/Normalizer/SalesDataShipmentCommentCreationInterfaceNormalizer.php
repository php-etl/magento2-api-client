...
class SalesDataShipmentCommentCreationInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataShipmentCommentCreationInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataShipmentCommentCreationInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataShipmentCommentCreationInterface();
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataShipmentCommentCreationInterface' => false);
    }
}