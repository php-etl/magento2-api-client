...
class SalesDataOrderItemInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataOrderItemInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataOrderItemInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataOrderItemInterface();
        ...
        if (\array_key_exists('parent_item', $data) && $data['parent_item'] !== null) {
            $object->setParentItem($this->denormalizer->denormalize($data['parent_item'], 'Kiboko\\Magento\\Model\\SalesDataOrderItemInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('product_option', $data) && $data['product_option'] !== null) {
            $object->setProductOption($this->denormalizer->denormalize($data['product_option'], 'Kiboko\\Magento\\Model\\CatalogDataProductOptionInterface', 'json', $context));
        }
        elseif (\array_key_exists('product_option', $data) && $data['product_option'] === null) {
            $object->setProductOption(null);
        }
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\Model\\SalesDataOrderItemExtensionInterface', 'json', $context));
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('baseOriginalPrice') && null !== $object->getBaseOriginalPrice()) {
        ...
        if ($object->isInitialized('baseRowInvoiced') && null !== $object->getBaseRowInvoiced()) {
        ...
        if ($object->isInitialized('baseTaxBeforeDiscount') && null !== $object->getBaseTaxBeforeDiscount()) {
        ...
        if ($object->isInitialized('extOrderItemId') && null !== $object->getExtOrderItemId()) {
            $data['ext_order_item_id'] = $object->getExtOrderItemId();
        }
        if ($object->isInitialized('freeShipping') && null !== $object->getFreeShipping()) {
        ...
        if ($object->isInitialized('gwBasePriceInvoiced') && null !== $object->getGwBasePriceInvoiced()) {
            $data['gw_base_price_invoiced'] = $object->getGwBasePriceInvoiced();
        }
        if ($object->isInitialized('gwBasePriceRefunded') && null !== $object->getGwBasePriceRefunded()) {
        ...
        if ($object->isInitialized('gwBaseTaxAmountInvoiced') && null !== $object->getGwBaseTaxAmountInvoiced()) {
            $data['gw_base_tax_amount_invoiced'] = $object->getGwBaseTaxAmountInvoiced();
        }
        if ($object->isInitialized('gwBaseTaxAmountRefunded') && null !== $object->getGwBaseTaxAmountRefunded()) {
            $data['gw_base_tax_amount_refunded'] = $object->getGwBaseTaxAmountRefunded();
        }
        if ($object->isInitialized('gwId') && null !== $object->getGwId()) {
            $data['gw_id'] = $object->getGwId();
        }
        if ($object->isInitialized('gwPrice') && null !== $object->getGwPrice()) {
            $data['gw_price'] = $object->getGwPrice();
        }
        if ($object->isInitialized('gwPriceInvoiced') && null !== $object->getGwPriceInvoiced()) {
            $data['gw_price_invoiced'] = $object->getGwPriceInvoiced();
        }
        if ($object->isInitialized('gwPriceRefunded') && null !== $object->getGwPriceRefunded()) {
        ...
        if ($object->isInitialized('gwTaxAmountInvoiced') && null !== $object->getGwTaxAmountInvoiced()) {
            $data['gw_tax_amount_invoiced'] = $object->getGwTaxAmountInvoiced();
        }
        if ($object->isInitialized('gwTaxAmountRefunded') && null !== $object->getGwTaxAmountRefunded()) {
        ...
        if ($object->isInitialized('discountTaxCompensationCanceled') && null !== $object->getDiscountTaxCompensationCanceled()) {
        ...
        if ($object->isInitialized('isQtyDecimal') && null !== $object->getIsQtyDecimal()) {
        ...
        if ($object->isInitialized('lockedDoInvoice') && null !== $object->getLockedDoInvoice()) {
            $data['locked_do_invoice'] = $object->getLockedDoInvoice();
        }
        if ($object->isInitialized('lockedDoShip') && null !== $object->getLockedDoShip()) {
            $data['locked_do_ship'] = $object->getLockedDoShip();
        }
        if ($object->isInitialized('name') && null !== $object->getName()) {
            $data['name'] = $object->getName();
        }
        if ($object->isInitialized('noDiscount') && null !== $object->getNoDiscount()) {
        ...
        if ($object->isInitialized('qtyBackordered') && null !== $object->getQtyBackordered()) {
            $data['qty_backordered'] = $object->getQtyBackordered();
        }
        if ($object->isInitialized('qtyCanceled') && null !== $object->getQtyCanceled()) {
            $data['qty_canceled'] = $object->getQtyCanceled();
        }
        if ($object->isInitialized('qtyInvoiced') && null !== $object->getQtyInvoiced()) {
            $data['qty_invoiced'] = $object->getQtyInvoiced();
        }
        if ($object->isInitialized('qtyOrdered') && null !== $object->getQtyOrdered()) {
            $data['qty_ordered'] = $object->getQtyOrdered();
        }
        if ($object->isInitialized('qtyRefunded') && null !== $object->getQtyRefunded()) {
            $data['qty_refunded'] = $object->getQtyRefunded();
        }
        if ($object->isInitialized('qtyReturned') && null !== $object->getQtyReturned()) {
            $data['qty_returned'] = $object->getQtyReturned();
        }
        if ($object->isInitialized('qtyShipped') && null !== $object->getQtyShipped()) {
            $data['qty_shipped'] = $object->getQtyShipped();
        }
        if ($object->isInitialized('quoteItemId') && null !== $object->getQuoteItemId()) {
            $data['quote_item_id'] = $object->getQuoteItemId();
        }
        if ($object->isInitialized('rowInvoiced') && null !== $object->getRowInvoiced()) {
        ...
        if ($object->isInitialized('rowWeight') && null !== $object->getRowWeight()) {
        ...
        if ($object->isInitialized('taxBeforeDiscount') && null !== $object->getTaxBeforeDiscount()) {
        ...
        if ($object->isInitialized('parentItem') && null !== $object->getParentItem()) {
            $data['parent_item'] = $this->normalizer->normalize($object->getParentItem(), 'json', $context);
        }
        if ($object->isInitialized('productOption') && null !== $object->getProductOption()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataOrderItemInterface' => false);
    }
}