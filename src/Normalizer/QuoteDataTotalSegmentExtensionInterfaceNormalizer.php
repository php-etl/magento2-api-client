...
class QuoteDataTotalSegmentExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('vertex_tax_calculation_messages', $data) && $data['vertex_tax_calculation_messages'] !== null) {
            $values_1 = array();
            foreach ($data['vertex_tax_calculation_messages'] as $value_1) {
                $values_1[] = $value_1;
            }
            $object->setVertexTaxCalculationMessages($values_1);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('vertexTaxCalculationMessages') && null !== $object->getVertexTaxCalculationMessages()) {
            $values_1 = array();
            foreach ($object->getVertexTaxCalculationMessages() as $value_1) {
                $values_1[] = $value_1;
            }
            $data['vertex_tax_calculation_messages'] = $values_1;
        }
        return $data;
    }
