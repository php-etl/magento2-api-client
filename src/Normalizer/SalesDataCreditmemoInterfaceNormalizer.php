...
class SalesDataCreditmemoInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\SalesDataCreditmemoInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\SalesDataCreditmemoInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\SalesDataCreditmemoInterface();
        if (\array_key_exists('adjustment', $data) && \is_int($data['adjustment'])) {
            $data['adjustment'] = (double) $data['adjustment'];
        }
        ...
        if (\array_key_exists('base_adjustment', $data) && \is_int($data['base_adjustment'])) {
            $data['base_adjustment'] = (double) $data['base_adjustment'];
        }
        ...
        if (\array_key_exists('adjustment', $data) && $data['adjustment'] !== null) {
            $object->setAdjustment($data['adjustment']);
        }
        elseif (\array_key_exists('adjustment', $data) && $data['adjustment'] === null) {
            $object->setAdjustment(null);
        }
        ...
        if (\array_key_exists('base_adjustment', $data) && $data['base_adjustment'] !== null) {
            $object->setBaseAdjustment($data['base_adjustment']);
        }
        elseif (\array_key_exists('base_adjustment', $data) && $data['base_adjustment'] === null) {
            $object->setBaseAdjustment(null);
        }
        ...
        if (\array_key_exists('creditmemo_status', $data) && $data['creditmemo_status'] !== null) {
            $object->setCreditmemoStatus($data['creditmemo_status']);
        }
        elseif (\array_key_exists('creditmemo_status', $data) && $data['creditmemo_status'] === null) {
            $object->setCreditmemoStatus(null);
        }
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\Model\\SalesDataCreditmemoItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('comments', $data) && $data['comments'] !== null) {
            ...
            foreach ($data['comments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\Model\\SalesDataCreditmemoCommentInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('extension_attributes', $data) && $data['extension_attributes'] !== null) {
            $object->setExtensionAttributes($this->denormalizer->denormalize($data['extension_attributes'], 'Kiboko\\Magento\\Model\\SalesDataCreditmemoExtensionInterface', 'json', $context));
        }
    ...
    {
        $data = array();
        if ($object->isInitialized('adjustment') && null !== $object->getAdjustment()) {
        ...
        if ($object->isInitialized('baseAdjustment') && null !== $object->getBaseAdjustment()) {
        ...
        if ($object->isInitialized('creditmemoStatus') && null !== $object->getCreditmemoStatus()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\SalesDataCreditmemoInterface' => false);
    }
}