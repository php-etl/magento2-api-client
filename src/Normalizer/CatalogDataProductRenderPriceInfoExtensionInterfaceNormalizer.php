...
class CatalogDataProductRenderPriceInfoExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\CatalogDataProductRenderPriceInfoExtensionInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('msrp', $data)) {
            $object->setMsrp($this->denormalizer->denormalize($data['msrp'], 'Kiboko\\Magento\\V2\\Model\\MsrpDataProductRenderMsrpPriceInfoInterface', 'json', $context));
        }
