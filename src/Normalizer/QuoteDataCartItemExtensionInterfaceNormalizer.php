...
class QuoteDataCartItemExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2\\Model\\QuoteDataCartItemExtensionInterface';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2\\Model\\QuoteDataCartItemExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2\Model\QuoteDataCartItemExtensionInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('negotiable_quote_item', $data)) {
            $object->setNegotiableQuoteItem($this->denormalizer->denormalize($data['negotiable_quote_item'], 'Kiboko\\Magento\\V2\\Model\\NegotiableQuoteDataNegotiableQuoteItemInterface', 'json', $context));
        }
        return $object;
    }
    /**
