...
class V1CustomersIsEmailAvailablePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\V1CustomersIsEmailAvailablePostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\V1CustomersIsEmailAvailablePostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\V1CustomersIsEmailAvailablePostBody();
    ...
    {
        return array('Kiboko\\Magento\\Model\\V1CustomersIsEmailAvailablePostBody' => false);
    }
}