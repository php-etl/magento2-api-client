...
class QuoteDataTotalsExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\Model\\QuoteDataTotalsExtensionInterface';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\Model\\QuoteDataTotalsExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\Model\QuoteDataTotalsExtensionInterface();
    ...
    {
        $data = array();
        if ($object->isInitialized('couponLabel') && null !== $object->getCouponLabel()) {
    ...
    {
        return array('Kiboko\\Magento\\Model\\QuoteDataTotalsExtensionInterface' => false);
    }
}