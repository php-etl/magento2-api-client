...
class Client extends \Kiboko\Magento\Runtime\Client\Client
{
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AdobeStockImageApiGetImageListV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AdobeStockImageApiGetImageListV1ExecuteGetInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AdobeStockImageApiGetImageListV1ExecuteGet($queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     ...
     * @throws \Kiboko\Magento\Exception\QuoteCartManagementV1AssignCustomerPutInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\QuoteCartManagementV1AssignCustomerPutBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsBulkStatusV1GetBulkDetailedStatusGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsBulkStatusV1GetBulkDetailedStatusGetBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AsynchronousOperationsBulkStatusV1GetBulkDetailedStatusGet($bulkUuid), $fetch);
    }
    /**
     ...
     * @param string $bulkUuid 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsBulkStatusV1GetBulkShortStatusGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsBulkStatusV1GetBulkShortStatusGetBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AsynchronousOperationsBulkStatusV1GetBulkShortStatusGet($bulkUuid), $fetch);
    }
    /**
     ...
     * @param int $status 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsBulkStatusV1GetOperationsCountByBulkIdAndStatusGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AsynchronousOperationsBulkStatusV1GetOperationsCountByBulkIdAndStatusGet($bulkUuid, $status), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AsynchronousOperationsOperationRepositoryV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AsynchronousOperationsOperationRepositoryV1GetListGet($queryParameters), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiSourceRepositoryV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceRepositoryV1GetListGet($queryParameters), $fetch);
    }
    /**
     * Save Source data
     *
     ...
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiSourceRepositoryV1SavePost(\Kiboko\Magento\Model\V1InventorySourcesPostBody $inventoryApiSourceRepositoryV1SavePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceRepositoryV1SavePost($inventoryApiSourceRepositoryV1SavePostBody), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceRepositoryV1GetGet($sourceCode), $fetch);
    }
    /**
     * Save Source data
     *
     ...
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiSourceRepositoryV1SavePut(string $sourceCode, \Kiboko\Magento\Model\V1InventorySourcesSourceCodePutBody $inventoryApiSourceRepositoryV1SavePutBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceRepositoryV1SavePut($sourceCode, $inventoryApiSourceRepositoryV1SavePutBody), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiGetSourcesAssignedToStockOrderedByPriorityV1ExecuteGet($stockId), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiStockRepositoryV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockRepositoryV1GetListGet($queryParameters), $fetch);
    }
    /**
     * Save Stock data
     *
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiStockRepositoryV1SavePost(\Kiboko\Magento\Model\V1InventoryStocksPostBody $inventoryApiStockRepositoryV1SavePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockRepositoryV1SavePost($inventoryApiStockRepositoryV1SavePostBody), $fetch);
    }
    /**
     ...
     * @param int $stockId 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiStockRepositoryV1DeleteByIdDeleteUnauthorizedException
     * @throws \Kiboko\Magento\Exception\InventoryApiStockRepositoryV1DeleteByIdDeleteBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockRepositoryV1DeleteByIdDelete($stockId), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockRepositoryV1GetGet($stockId), $fetch);
    }
    /**
     * Save Stock data
     *
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiStockRepositoryV1SavePut(string $stockId, \Kiboko\Magento\Model\V1InventoryStocksStockIdPutBody $inventoryApiStockRepositoryV1SavePutBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockRepositoryV1SavePut($stockId, $inventoryApiStockRepositoryV1SavePutBody), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiGetStockSourceLinksV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiGetStockSourceLinksV1ExecuteGet($queryParameters), $fetch);
    }
    /**
     * Save StockSourceLink list data
     *
     * @param \Kiboko\Magento\Model\V1InventoryStockSourceLinksPostBody $inventoryApiStockSourceLinksSaveV1ExecutePostBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiStockSourceLinksSaveV1ExecutePostUnauthorizedException
     * @throws \Kiboko\Magento\Exception\InventoryApiStockSourceLinksSaveV1ExecutePostBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiStockSourceLinksSaveV1ExecutePost(\Kiboko\Magento\Model\V1InventoryStockSourceLinksPostBody $inventoryApiStockSourceLinksSaveV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockSourceLinksSaveV1ExecutePost($inventoryApiStockSourceLinksSaveV1ExecutePostBody), $fetch);
    }
    /**
     ...
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiStockSourceLinksDeleteV1ExecutePost(\Kiboko\Magento\Model\V1InventoryStockSourceLinksDeletePostBody $inventoryApiStockSourceLinksDeleteV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiStockSourceLinksDeleteV1ExecutePost($inventoryApiStockSourceLinksDeleteV1ExecutePostBody), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryApiSourceItemRepositoryV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceItemRepositoryV1GetListGet($queryParameters), $fetch);
    }
    /**
     ...
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiSourceItemsSaveV1ExecutePost(\Kiboko\Magento\Model\V1InventorySourceItemsPostBody $inventoryApiSourceItemsSaveV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceItemsSaveV1ExecutePost($inventoryApiSourceItemsSaveV1ExecutePostBody), $fetch);
    }
    /**
     ...
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryApiSourceItemsDeleteV1ExecutePost(\Kiboko\Magento\Model\V1InventorySourceItemsDeletePostBody $inventoryApiSourceItemsDeleteV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryApiSourceItemsDeleteV1ExecutePost($inventoryApiSourceItemsDeleteV1ExecutePostBody), $fetch);
    }
    /**
     * Run mass product to source assignment
     *
     * @param \Kiboko\Magento\Model\V1InventoryBulkProductSourceAssignPostBody $inventoryCatalogApiBulkSourceAssignV1ExecutePostBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryCatalogApiBulkSourceAssignV1ExecutePostUnauthorizedException
     * @throws \Kiboko\Magento\Exception\InventoryCatalogApiBulkSourceAssignV1ExecutePostBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryCatalogApiBulkSourceAssignV1ExecutePost(\Kiboko\Magento\Model\V1InventoryBulkProductSourceAssignPostBody $inventoryCatalogApiBulkSourceAssignV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryCatalogApiBulkSourceAssignV1ExecutePost($inventoryCatalogApiBulkSourceAssignV1ExecutePostBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryCatalogApiBulkSourceUnassignV1ExecutePost(\Kiboko\Magento\Model\V1InventoryBulkProductSourceUnassignPostBody $inventoryCatalogApiBulkSourceUnassignV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryCatalogApiBulkSourceUnassignV1ExecutePost($inventoryCatalogApiBulkSourceUnassignV1ExecutePostBody), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryCatalogApiBulkInventoryTransferV1ExecutePost(\Kiboko\Magento\Model\V1InventoryBulkProductSourceTransferPostBody $inventoryCatalogApiBulkInventoryTransferV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryCatalogApiBulkInventoryTransferV1ExecutePost($inventoryCatalogApiBulkInventoryTransferV1ExecutePostBody), $fetch);
    }
    /**
     * Run bulk partial inventory transfer for specified items.
     *
     * @param \Kiboko\Magento\Model\V1InventoryBulkPartialSourceTransferPostBody $inventoryCatalogApiBulkPartialInventoryTransferV1ExecutePostBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryCatalogApiBulkPartialInventoryTransferV1ExecutePostUnauthorizedException
     * @throws \Kiboko\Magento\Exception\InventoryCatalogApiBulkPartialInventoryTransferV1ExecutePostBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryCatalogApiBulkPartialInventoryTransferV1ExecutePost(\Kiboko\Magento\Model\V1InventoryBulkPartialSourceTransferPostBody $inventoryCatalogApiBulkPartialInventoryTransferV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryCatalogApiBulkPartialInventoryTransferV1ExecutePost($inventoryCatalogApiBulkPartialInventoryTransferV1ExecutePostBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryDistanceBasedSourceSelectionApiGetDistanceProviderCodeV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryDistanceBasedSourceSelectionApiGetDistanceProviderCodeV1ExecuteGet(), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryDistanceBasedSourceSelectionApiGetDistanceV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryDistanceBasedSourceSelectionApiGetDistanceV1ExecuteGet($queryParameters), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryDistanceBasedSourceSelectionApiGetLatLngFromAddressV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryDistanceBasedSourceSelectionApiGetLatLngFromAddressV1ExecuteGet($queryParameters), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryExportStockApiExportStockSalableQtyV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryExportStockApiExportStockSalableQtyV1ExecuteGet($salesChannelType, $salesChannelCode, $queryParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryExportStockApiExportStockIndexDataV1ExecuteGet($salesChannelType, $salesChannelCode), $fetch);
    }
    /**
     ...
     * @param int $stockId 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventorySalesApiGetProductSalableQtyV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\InventorySalesApiGetProductSalableQtyV1ExecuteGetBadRequestException
     * @throws \Kiboko\Magento\Exception\InventorySalesApiGetProductSalableQtyV1ExecuteGetInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySalesApiGetProductSalableQtyV1ExecuteGet($sku, $stockId), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySalesApiIsProductSalableV1ExecuteGet($sku, $stockId), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySalesApiIsProductSalableForRequestedQtyV1ExecuteGet($sku, $stockId, $requestedQty), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySalesApiStockResolverV1ExecuteGet($type, $code), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryLowQuantityNotificationApiGetSourceItemConfigurationV1ExecuteGet($sourceCode, $sku), $fetch);
    }
    /**
     * 
     *
     * @param \Kiboko\Magento\Model\V1InventoryLowQuantityNotificationPostBody $inventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePostBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePostUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePost(\Kiboko\Magento\Model\V1InventoryLowQuantityNotificationPostBody $inventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePost($inventoryLowQuantityNotificationApiSourceItemConfigurationsSaveV1ExecutePostBody), $fetch);
    }
    /**
     * Delete multiple source items configuration for low quantity
     *
     * @param \Kiboko\Magento\Model\V1InventoryLowQuantityNotificationsDeletePostBody $inventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePostBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePostUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function inventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePost(\Kiboko\Magento\Model\V1InventoryLowQuantityNotificationsDeletePostBody $inventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePost($inventoryLowQuantityNotificationApiDeleteSourceItemsConfigurationV1ExecutePostBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\InventorySourceSelectionApiGetSourceSelectionAlgorithmListV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySourceSelectionApiGetSourceSelectionAlgorithmListV1ExecuteGet(), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function inventorySourceSelectionApiSourceSelectionServiceV1ExecutePost(\Kiboko\Magento\Model\V1InventorySourceSelectionAlgorithmResultPostBody $inventorySourceSelectionApiSourceSelectionServiceV1ExecutePostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\InventorySourceSelectionApiSourceSelectionServiceV1ExecutePost($inventorySourceSelectionApiSourceSelectionServiceV1ExecutePostBody), $fetch);
    }
    /**
     * Delete asset
     *
     * @param int $id 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiAssetRepositoryV1DeleteByIdDeleteUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiAssetRepositoryV1DeleteByIdDeleteInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AdobeStockAssetApiAssetRepositoryV1DeleteByIdDelete($id), $fetch);
    }
    /**
     * Get asset by id
     *
     * @param int $id 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiAssetRepositoryV1GetByIdGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiAssetRepositoryV1GetByIdGetInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AdobeStockAssetApiAssetRepositoryV1GetByIdGet($id), $fetch);
    }
    /**
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiAssetRepositoryV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AdobeStockAssetApiAssetRepositoryV1GetListGet($queryParameters), $fetch);
    }
    /**
     * Search for images based on search criteria
     *
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiGetAssetListV1ExecuteGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\AdobeStockAssetApiGetAssetListV1ExecuteGetInternalServerErrorException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\FrameworkSearchSearchResultInterface|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\AdobeStockAssetApiGetAssetListV1ExecuteGet($queryParameters), $fetch);
    }
    /**
     * Delete rule by ID.
     *
     ...
     * }
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\CheckoutAgreementsCheckoutAgreementsListV1GetListGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\CheckoutAgreementsDataAgreementInterface[]|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\CheckoutAgreementsCheckoutAgreementsListV1GetListGet($queryParameters), $fetch);
    }
    /**
    ...
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\MSPTwoFactorAuthTfaV1GetAllProvidersGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\MSpTwoFactorAuthProviderInterface[]|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function mSPTwoFactorAuthTfaV1GetAllProvidersGet(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1GetAllProvidersGet(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1GetForcedProvidersGet(), $fetch);
    }
    /**
     * Get a user provider
     *
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1GetUserProvidersGet($userId), $fetch);
    }
    /**
     * Set providers
     *
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function mSPTwoFactorAuthTfaV1SetProvidersCodesPut(int $userId, \Kiboko\Magento\Model\V1Msp2faUserProvidersUserIdPutBody $mSPTwoFactorAuthTfaV1SetProvidersCodesPutBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1SetProvidersCodesPut($userId, $mSPTwoFactorAuthTfaV1SetProvidersCodesPutBody), $fetch);
    }
    /**
     ...
     * @param int $userId 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\MSPTwoFactorAuthTfaV1GetProvidersToActivateGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\MSpTwoFactorAuthProviderInterface[]|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1GetProvidersToActivateGet($userId), $fetch);
    }
    /**
     ...
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\MSpTwoFactorAuthDataTrustedInterface[]|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function mSPTwoFactorAuthTfaV1GetTrustedDevicesGet(int $userId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1GetTrustedDevicesGet($userId), $fetch);
    }
    /**
     ...
     * @param int $userId 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\MSPTwoFactorAuthUserConfigManagerV1GetDefaultProviderGetUnauthorizedException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthUserConfigManagerV1GetDefaultProviderGet($userId), $fetch);
    }
    /**
     ...
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function mSPTwoFactorAuthTfaV1SetDefaultProviderCodePut(int $userId, \Kiboko\Magento\Model\V1Msp2faDefaultProviderCodeUserIdPutBody $mSPTwoFactorAuthTfaV1SetDefaultProviderCodePutBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1SetDefaultProviderCodePut($userId, $mSPTwoFactorAuthTfaV1SetDefaultProviderCodePutBody), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTfaV1ResetProviderConfigPost($userId, $providerCode), $fetch);
    }
    /**
     ...
     * @param int $tokenId 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \Kiboko\Magento\Exception\MSPTwoFactorAuthTrustedManagerV1RevokeTrustedDeviceDeleteUnauthorizedException
     * @throws \Kiboko\Magento\Exception\MSPTwoFactorAuthTrustedManagerV1RevokeTrustedDeviceDeleteBadRequestException
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return null|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\MSPTwoFactorAuthTrustedManagerV1RevokeTrustedDeviceDelete($tokenId), $fetch);
    }
    /**
     ...
     * @throws \Kiboko\Magento\Exception\UnexpectedStatusCodeException
     *
     * @return \Kiboko\Magento\Model\VertexAddressValidationApiDataCleansedAddressInterface|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function vertexAddressValidationApiCleanseAddressV1CleanseAddressPost(\Kiboko\Magento\Model\V1AddressCleansePostBody $vertexAddressValidationApiCleanseAddressV1CleanseAddressPostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\VertexAddressValidationApiCleanseAddressV1CleanseAddressPost($vertexAddressValidationApiCleanseAddressV1CleanseAddressPostBody), $fetch);
    }
    /**
     * Query Vertex to cleanse an address
     *
     ...
     * @return \Kiboko\Magento\Model\VertexAddressValidationApiDataCleansedAddressInterface|\Kiboko\Magento\Model\ErrorResponse|\Psr\Http\Message\ResponseInterface
     */
    public function vertexAddressValidationApiGuestCleanseAddressV1CleanseAddressPost(\Kiboko\Magento\Model\V1GuestAddressCleansePostBody $vertexAddressValidationApiGuestCleanseAddressV1CleanseAddressPostBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Kiboko\Magento\Endpoint\VertexAddressValidationApiGuestCleanseAddressV1CleanseAddressPost($vertexAddressValidationApiGuestCleanseAddressV1CleanseAddressPostBody), $fetch);
    }
    /**
     * 
     *
