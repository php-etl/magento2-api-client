...
class QuoteGuestPaymentMethodManagementV1SetPut extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $cartId, ?\Kiboko\Magento\V2_2\Model\V1GuestCartsCartIdSelectedPaymentMethodPutBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1GuestCartsCartIdSelectedPaymentMethodPutBody) {
