...
class SharedCatalogProductManagementV1AssignProductsPost extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $id, ?\Kiboko\Magento\V2_2\Model\V1SharedCatalogIdAssignProductsPostBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1SharedCatalogIdAssignProductsPostBody) {
