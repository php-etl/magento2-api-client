...
class NegotiableQuoteNegotiableQuoteShippingManagementV1SetShippingMethodPut extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $quoteId, ?\Kiboko\Magento\V2_2\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1NegotiableQuoteQuoteIdShippingMethodPutBody) {
