...
class CmsBlockRepositoryV1SavePut extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\Kiboko\Magento\v2_2\Model\V1CmsBlockIdPutBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1CmsBlockIdPutBody) {
