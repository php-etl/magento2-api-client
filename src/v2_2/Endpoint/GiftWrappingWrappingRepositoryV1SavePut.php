...
class GiftWrappingWrappingRepositoryV1SavePut extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $wrappingId, ?\Kiboko\Magento\V2_2\Model\V1GiftWrappingsWrappingIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1GiftWrappingsWrappingIdPutBody) {
