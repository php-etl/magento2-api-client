...
class NegotiableQuoteShippingInformationManagementV1SaveAddressInformationPost extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, ?\Kiboko\Magento\v2_2\Model\V1NegotiableCartsCartIdShippingInformationPostBody $requestBody = null)
    {
        $this->cartId = $cartId;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1NegotiableCartsCartIdShippingInformationPostBody) {
