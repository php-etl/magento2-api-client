...
class NegotiableQuoteNegotiableQuotePriceManagementV1PricesUpdatedPost extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\V2_2\Model\V1NegotiableQuotePricesUpdatedPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1NegotiableQuotePricesUpdatedPostBody) {
