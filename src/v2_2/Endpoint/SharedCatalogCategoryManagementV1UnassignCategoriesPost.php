...
class SharedCatalogCategoryManagementV1UnassignCategoriesPost extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $id, ?\Kiboko\Magento\v2_2\Model\V1SharedCatalogIdUnassignCategoriesPostBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1SharedCatalogIdUnassignCategoriesPostBody) {
