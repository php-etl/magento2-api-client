...
class CompanyCreditCreditHistoryManagementV1UpdatePut extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $historyId, ?\Kiboko\Magento\v2_2\Model\V1CompanyCreditsHistoryHistoryIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1CompanyCreditsHistoryHistoryIdPutBody) {
