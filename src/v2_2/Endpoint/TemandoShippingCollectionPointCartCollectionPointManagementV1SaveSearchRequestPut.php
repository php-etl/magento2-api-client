...
class TemandoShippingCollectionPointCartCollectionPointManagementV1SaveSearchRequestPut extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Kiboko\Magento\v2_2\Model\V1CartsMineCollectionPointSearchRequestPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1CartsMineCollectionPointSearchRequestPutBody) {
