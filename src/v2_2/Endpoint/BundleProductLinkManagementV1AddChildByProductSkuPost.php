...
class BundleProductLinkManagementV1AddChildByProductSkuPost extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, int $optionId, ?\Kiboko\Magento\V2_2\Model\V1BundleProductsSkuLinksOptionIdPostBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1BundleProductsSkuLinksOptionIdPostBody) {
