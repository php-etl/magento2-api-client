...
class SalesInvoiceOrderV1ExecutePost extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $orderId, ?\Kiboko\Magento\V2_2\Model\V1OrderOrderIdInvoicePostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1OrderOrderIdInvoicePostBody) {
