...
class CompanyTeamRepositoryV1CreatePost extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $companyId, ?\Kiboko\Magento\v2_2\Model\V1TeamCompanyIdPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1TeamCompanyIdPostBody) {
