...
class NegotiableQuoteNegotiableCartRepositoryV1SavePut extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $quoteId, ?\Kiboko\Magento\V2_2\Model\V1NegotiableQuoteQuoteIdPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1NegotiableQuoteQuoteIdPutBody) {
