...
class CatalogCategoryLinkRepositoryV1SavePut extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $categoryId, ?\Kiboko\Magento\v2_2\Model\V1CategoriesCategoryIdProductsPutBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1CategoriesCategoryIdProductsPutBody) {
