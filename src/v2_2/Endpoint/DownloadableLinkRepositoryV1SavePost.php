...
class DownloadableLinkRepositoryV1SavePost extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, ?\Kiboko\Magento\v2_2\Model\V1ProductsSkuDownloadableLinksPostBody $requestBody = null)
    {
        $this->sku = $sku;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\v2_2\Model\V1ProductsSkuDownloadableLinksPostBody) {
