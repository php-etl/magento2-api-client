...
class NegotiableQuoteShippingMethodManagementV1EstimateByAddressIdPost extends \Kiboko\Magento\v2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\v2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $cartId, \Kiboko\Magento\v2_2\Model\V1NegotiableCartsCartIdEstimateShippingMethodsByAddressIdPostBody $negotiableQuoteShippingMethodManagementV1EstimateByAddressIdPostBody)
    {
        $this->cartId = $cartId;
