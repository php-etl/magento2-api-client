...
class BundleProductLinkManagementV1SaveChildPut extends \Kiboko\Magento\V2_2\Runtime\Client\BaseEndpoint implements \Kiboko\Magento\V2_2\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $sku, string $id, ?\Kiboko\Magento\V2_2\Model\V1BundleProductsSkuLinksIdPutBody $requestBody = null)
    {
        $this->sku = $sku;
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Kiboko\Magento\V2_2\Model\V1BundleProductsSkuLinksIdPutBody) {
