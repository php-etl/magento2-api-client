...
class CustomerDataCustomerExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_2\\Model\\CustomerDataCustomerExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_2\\Model\\CustomerDataCustomerExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_2\Model\CustomerDataCustomerExtensionInterface();
        ...
        if (\array_key_exists('company_attributes', $data)) {
            $object->setCompanyAttributes($this->denormalizer->denormalize($data['company_attributes'], 'Kiboko\\Magento\\V2_2\\Model\\CompanyDataCompanyCustomerInterface', 'json', $context));
        }
