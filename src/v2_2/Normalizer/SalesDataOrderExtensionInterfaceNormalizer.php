    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('shipping_assignments', $data)) {
            ...
            foreach ($data['shipping_assignments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_2\\Model\\SalesDataShippingAssignmentInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('payment_additional_info', $data)) {
            ...
            foreach ($data['payment_additional_info'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_2\\Model\\PaymentDataPaymentAdditionalInfoInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('applied_taxes', $data)) {
            ...
            foreach ($data['applied_taxes'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_2\\Model\\TaxDataOrderTaxDetailsAppliedTaxInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('item_applied_taxes', $data)) {
            ...
            foreach ($data['item_applied_taxes'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\v2_2\\Model\\TaxDataOrderTaxDetailsItemInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('gift_cards', $data)) {
            ...
            foreach ($data['gift_cards'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Kiboko\\Magento\\v2_2\\Model\\GiftCardAccountDataGiftCardInterface', 'json', $context);
            }
