...
class DownloadableDataLinkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataLinkInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataLinkInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_2\Model\DownloadableDataLinkInterface();
        ...
        if (\array_key_exists('link_file_content', $data)) {
            $object->setLinkFileContent($this->denormalizer->denormalize($data['link_file_content'], 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataFileContentInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('sample_file_content', $data)) {
            $object->setSampleFileContent($this->denormalizer->denormalize($data['sample_file_content'], 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataFileContentInterface', 'json', $context));
        }
