...
class CompanyDataCompanyExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\v2_2\\Model\\CompanyDataCompanyExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\v2_2\\Model\\CompanyDataCompanyExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\v2_2\Model\CompanyDataCompanyExtensionInterface();
        ...
        if (\array_key_exists('quote_config', $data)) {
            $object->setQuoteConfig($this->denormalizer->denormalize($data['quote_config'], 'Kiboko\\Magento\\v2_2\\Model\\NegotiableQuoteDataCompanyQuoteConfigInterface', 'json', $context));
        }
