...
class CatalogDataProductRenderPriceInfoExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_2\\Model\\CatalogDataProductRenderPriceInfoExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_2\\Model\\CatalogDataProductRenderPriceInfoExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_2\Model\CatalogDataProductRenderPriceInfoExtensionInterface();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('msrp', $data) && $data['msrp'] !== null) {
            $object->setMsrp($this->denormalizer->denormalize($data['msrp'], 'Kiboko\\Magento\\V2_2\\Model\\MsrpDataProductRenderMsrpPriceInfoInterface', 'json', $context));
        } elseif (\array_key_exists('msrp', $data) && $data['msrp'] === null) {
            $object->setMsrp(null);
        }
        if (\array_key_exists('tax_adjustments', $data) && $data['tax_adjustments'] !== null) {
            $object->setTaxAdjustments($this->denormalizer->denormalize($data['tax_adjustments'], 'Kiboko\\Magento\\V2_2\\Model\\CatalogDataProductRenderPriceInfoInterface', 'json', $context));
        ...
        if (\array_key_exists('weee_attributes', $data) && $data['weee_attributes'] !== null) {
            ...
            foreach ($data['weee_attributes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_2\\Model\\WeeeDataProductRenderWeeeAdjustmentAttributeInterface', 'json', $context);
            }
