...
class QuoteDataTotalsAdditionalDataExtensionInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Kiboko\\Magento\\V2_2\\Model\\QuoteDataTotalsAdditionalDataExtensionInterface';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'Kiboko\\Magento\\V2_2\\Model\\QuoteDataTotalsAdditionalDataExtensionInterface';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Kiboko\Magento\V2_2\Model\QuoteDataTotalsAdditionalDataExtensionInterface();
        ...
        if (\array_key_exists('gift_messages', $data) && $data['gift_messages'] !== null) {
            ...
            foreach ($data['gift_messages'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\V2_2\\Model\\GiftMessageDataMessageInterface', 'json', $context);
            }
