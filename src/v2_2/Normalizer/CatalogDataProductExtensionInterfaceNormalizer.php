    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('bundle_product_options', $data)) {
            ...
            foreach ($data['bundle_product_options'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_2\\Model\\BundleDataOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('downloadable_product_links', $data)) {
            ...
            foreach ($data['downloadable_product_links'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataLinkInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('downloadable_product_samples', $data)) {
            ...
            foreach ($data['downloadable_product_samples'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Kiboko\\Magento\\v2_2\\Model\\DownloadableDataSampleInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('giftcard_amounts', $data)) {
            ...
            foreach ($data['giftcard_amounts'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Kiboko\\Magento\\v2_2\\Model\\GiftCardDataGiftcardAmountInterface', 'json', $context);
            }
