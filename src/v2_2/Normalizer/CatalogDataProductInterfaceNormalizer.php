    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('product_links', $data)) {
            ...
            foreach ($data['product_links'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Kiboko\\Magento\\v2_2\\Model\\CatalogDataProductLinkInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data)) {
            ...
            foreach ($data['options'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Kiboko\\Magento\\v2_2\\Model\\CatalogDataProductCustomOptionInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('media_gallery_entries', $data)) {
            ...
            foreach ($data['media_gallery_entries'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Kiboko\\Magento\\v2_2\\Model\\CatalogDataProductAttributeMediaGalleryEntryInterface', 'json', $context);
            }
        ...
        if (\array_key_exists('tier_prices', $data)) {
            ...
            foreach ($data['tier_prices'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Kiboko\\Magento\\v2_2\\Model\\CatalogDataProductTierPriceInterface', 'json', $context);
            }
