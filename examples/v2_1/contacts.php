...
try {
    $response = $client->customerCustomerRepositoryV1GetListGet(queryParameters: [
        'searchCriteria[currentPage]' => 1,
        'searchCriteria[pageSize]' => 10,
    ], fetch: \Kiboko\Magento\v2_1\Client::FETCH_RESPONSE);
} catch (\Kiboko\Magento\v2_1\Exception\CustomerCustomerRepositoryV1GetListGetUnauthorizedException) {
}
