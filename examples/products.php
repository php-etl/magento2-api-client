...
use Kiboko\Magento\V2\Exception\CatalogProductRepositoryV1GetListGetUnauthorizedException;
...
} catch (CatalogProductRepositoryV1GetListGetUnauthorizedException) {
}
